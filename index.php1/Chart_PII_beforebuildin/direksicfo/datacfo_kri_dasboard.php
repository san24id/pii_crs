...
FROM t_kri a LEFT JOIN m_division b ON b.`division_id` = a.`kri_owner` WHERE a.kri_owner IN (SELECT under_direksi FROM m_direksi WHERE division_id = 'D-CFO')) AS another
