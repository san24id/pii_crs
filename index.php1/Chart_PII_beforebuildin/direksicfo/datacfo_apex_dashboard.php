...
FROM t_risk_action_plan a JOIN m_division b ON b.division_id = a.`division` WHERE a.division IN (SELECT under_direksi FROM m_direksi WHERE division_id = 'D-CFO')) AS another
