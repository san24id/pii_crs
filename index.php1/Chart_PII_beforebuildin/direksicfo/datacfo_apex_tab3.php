...
FROM t_risk_action_plan a JOIN m_division b ON a.`division` = b.`division_id` WHERE a.division IN (SELECT under_direksi FROM m_direksi WHERE division_id = 'D-CFO')) AS another
