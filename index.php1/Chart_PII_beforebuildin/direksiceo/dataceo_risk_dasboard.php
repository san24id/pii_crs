...
FROM m_direksi c  LEFT JOIN t_risk a  ON a.risk_owner = c.under_direksi LEFT JOIN m_division b ON b.division_id = c.under_direksi WHERE c.division_id = 'D-CEO') AS another
