...
FROM t_risk a JOIN m_division b ON b.`division_id` = a.risk_owner WHERE a.risk_owner IN (SELECT under_direksi FROM m_direksi WHERE division_id = 'D-COO')) AS another
