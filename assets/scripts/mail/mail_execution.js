        ...
        "columnDefs":[{
        	...
        	"render": function ( data, type, full, meta ) {
        		...
        		return '<div class="btn-group">'+
           			'<button type="button" class="btn btn-default btn-xs" onclick="location.href=\''+site_url+'/admin/reminder/apex_edit/'+full.id+'\'"><i class="fa fa-pencil font-blue"> Edit </i></button>'+
	...
	return {
	        ...
	        deleteData: function(data) {
	        	...
	        	mod.find('button.btn-danger').one('click', function(){
	        		...
	        		var url = site_url+'/admin/reminder/MailapexDeleteData';
	        		$.post(
	        			url,
	        			{ 'id':  data.DT_RowId},
	        			function( data ) {
