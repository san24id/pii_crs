    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                ...
                var dat = '';
                if(stat == 0){
                    return '<a target="_self" href="'+site_url+'/main/mainpic/viewKriRegular/'+full.id+'">'+data+'</a>';
               }else{
                    if (ret == '' || ret == null) {
                        return '<a target="_self" href="'+site_url+'/main/mainpic/viewOwnedKriRegular/'+full.id+'">'+data+'</a>';
                    } else {
                        return '<a target="_self" href="'+site_url+'/main/mainpic/viewOwnedKriRegular/'+full.id+'">'+data+'</a>';
                    }
                    return dat;
