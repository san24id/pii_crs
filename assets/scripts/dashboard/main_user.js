        	...
        	"render": function ( data, type, full, meta ) {
        		...
        		if (data >= 2) {
        			...
        			tt = '<div class="btn-group">'+
        					'<button type="button" class="btn blue btn-xs button-grid-edit" onclick="location.href=\''+site_url+'/risk/RiskRegister/ChangeRequestInput/'+full.risk_id+'\'"><i class="fa fa-pencil"> Change Request </i></button>'+
