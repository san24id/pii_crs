...
gridRiskList.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": site_url+"/main/MainDireksi/getAllRisk" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
            "data": "risk_status",
...
gridActionExec.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": site_url+"/main/MainDireksi/getActionPlanExec" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
            "data": "action_plan_status",
...
grid_kri.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": site_url+"/main/MainDireksi/getKri" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
            "data": "kri_status",
...
$('#risk_list_excel').on('click', function() {
            ...
            if($('#get_check_risklist').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getAllRiskDireksiceo_excel'+'?'+searchnya+$('#get_check_risklist').serialize());
            }                    
...
$('#execution_list_excel').on('click', function() {
            ...
            if($('#get_check_execution').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getExecutionDireksiceo_excel'+'?'+$('#get_check_execution').serialize());
            }                    
...
$('#execution_list_pdf').on('click', function() {
            ...
            if($('#get_check_execution').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getExecutionDireksiceo_pdf'+'?'+$('#get_check_execution').serialize());
            }                    
...
$('#kri_list_excel').on('click', function() {
            ...
            if($('#get_check_kri').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getKRIDireksiceo_excel'+'?'+$('#get_check_kri').serialize());
            }                    
...
$('#kri_list_pdf').on('click', function() {
            ...
            if($('#get_check_kri').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getKRIDireksiceo_pdf'+'?'+$('#get_check_kri').serialize());
            }                    
