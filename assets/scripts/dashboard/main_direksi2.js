...
gridRiskList.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": site_url+"/main/MainDireksiRac/getAllRisk" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
            "data": "risk_status",
...
gridActionExec.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "ajax": {
            "url": site_url+"/main/MainDireksiRac/getActionPlanExec" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
...
grid_kri.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": site_url+"/main/MainDireksiRac/getKri" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
            "data": "kri_status",
...
$('#risk_list_excel').on('click', function() {
            ...
            if($('#get_check_risklist').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getAllRiskDireksi_excel'+'?'+searchnya+$('#get_check_risklist').serialize());
            }                    
...
$('#execution_list_excel').on('click', function() {
            ...
            if($('#get_check_execution').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getExecutionDireksi_excel'+'?'+$('#get_check_execution').serialize());
            }                    
...
$('#execution_list_pdf').on('click', function() {
            ...
            if($('#get_check_execution').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getExecutionDireksi_pdf'+'?'+$('#get_check_execution').serialize());
            }                    
...
$('#kri_list_excel').on('click', function() {
            ...
            if($('#get_check_kri').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getKRIDireksi_excel'+'?'+$('#get_check_kri').serialize());
            }                    
...
$('#kri_list_pdf').on('click', function() {
            ...
            if($('#get_check_kri').serialize() == ""){
                ...
                window.open(site_url+'/main/main/getKRIDireksi_pdf'+'?'+$('#get_check_kri').serialize());
            }                    
