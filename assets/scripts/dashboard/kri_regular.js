    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                ...
                var dat = '';
                if(stat == 0){
                        return '<a target="_self" href="'+site_url+'/main/mainrac/viewKriDesignationRegular/'+full.id+'">'+data+'</a>';
                }else{
                    if (ret == '' || ret == null) {
                        if(full.kri_status == 0){
                            return '<a target="_self" href="'+site_url+'/main/mainrac/viewOwnedKriRegular/'+full.id+'">'+data+'</a>';
                        }else{
                            return '<a target="_self" href="'+site_url+'/main/mainrac/viewKriRegular/'+full.id+'">'+data+'</a>';
                        }
