...
gridRiskList.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "stateSave" : true,    
        "ajax": {
            "url": site_url+"/main/mainrac/getAllAggRiskNew/"+id_periode // ajax source
        },
    "columnDefs": [{
            "targets": 0,
            "data": "risk_event",
            "render": function ( data, type, full, meta ) {
                ...
                return '<a target="_self" href="'+site_url+'/main/mainrac/viewRiskAggNew/'+full.risk_idag+'">'+data+'</a>';
            }
        },{
            "targets": 5,
            "data": "risk_id",
            "render": function ( data, type, full, meta ) {
                var img = '<div class="btn-group">'+
                            '<a href="'+site_url+'/main/mainrac/riskEditAggNewForm/'+id_periode+'/'+full.risk_idag+'"><button type="button" class="btn btn-default btn-xs button-grid-update"><i class="fa fa-edit font-blue"> Update/Transfer </i></button></a>'+
    ...
    return {
        ...
        deleteRiskAgg: function(data) {
                ...
                mod.find('button.btn-danger').one('click', function(){
                    ...
                    var url = site_url+'/main/mainrac/deleteRiskAggNew';          
                    Metronic.blockUI({ boxed: true });
                    $.post(
                        url,
                        $.param(eparam),
