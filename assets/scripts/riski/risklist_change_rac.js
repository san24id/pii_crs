...
var RiskList = function() {
	return {
	        ...
	        confirmRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin Roll Forward risiko ini ke periode saat ini, untuk risiko :<b>'+data.risk_event+'</b> ? ');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					//MainApp.viewGlobalModal('success', 'Sukses Update Status Resiko');
	        ...
	        deleteRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('warning', 'Apakah Anda yakin ingin <b>Menghapus</b> Risiko : <b>'+data.risk_event+'</b> ?');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					MainApp.viewGlobalModal('success', 'Sukses menghapus Resiko');
	        				} else {
	        					MainApp.viewGlobalModal('error', data.msg);
	        				}
	        ...
	        submitRiskPeriode: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin menyerahkan kepada RAC semua risiko yang teridentifikasi dalam periode ? : <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
	        ...
	        submitRiskPeriode2: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin mengubah permintaan untuk RAC semua risiko yang teridentifikasi dalam periode : <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
	         ...
	         submitRiskPeriode22: function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Menyetujui permintaan perubahan akan membuat Status semua risiko dalam daftar risiko ini kembali ke draft?');
                mod.find('button.btn-ok-success').one('click', function(){
                    mod.modal('hide');
	         ...
	         submitRiskPeriode222: function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Abaikan permintaan perubahan dalam Periode: <b>'+g_p_name+'</b>');
                mod.find('button.btn-ok-success').one('click', function(){
                    mod.modal('hide');
