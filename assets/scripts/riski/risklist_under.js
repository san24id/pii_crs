...
var RiskList = function() {
	return {
	        ...
	        confirmRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin memindahkan risiko ini ke Under Maintenance List, <br/> untuk risiko :'+data.risk_event+'</b> ? ');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					//MainApp.viewGlobalModal('success', 'Suskses memperbarui status risiko');
	        ...
	        draftRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('confirm', 'memperbarui status risiko menjadi <b> Draft </ b> untuk risiko: <b>'+data.risk_event+'</b> ? ');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
	        		var eparam = {
	        			'risk_id' : data.risk_id
	        ...
	        deleteRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('warning', 'Apakah Anda ingin memindahkan risiko ini ke Daftar Aktif,<br /> untuk risiko : <b>'+data.risk_event+'</b> ?');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					MainApp.viewGlobalModal('success', 'Berhasil, memindahkan Risiko ke Active List');
	        				} else {
	        					MainApp.viewGlobalModal('error', data.msg);
	        				}
	        ...
	        submitRiskPeriode2: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Permintaan Perubahan kepada RAC semua Risiko pada Periode : <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
