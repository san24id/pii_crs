    ...
    return {
        ...
        init: function() {
            ...
            $('#risk-set-as-primary').on('click', function () {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin menetapkan Data Perubahan sebagai Data Primer ?');
            ...
            $('#risk-button-draft').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Menyimpan Data Perubahan dari risiko ini?');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#primary-risk-button-verify').on('click', function () {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin mengatur Data Perawatan sebagai Data Primer?');
                mod.find('button.btn-primary').one('click', function(){
                    me.submitRiskData('verifyowned', false)
                });
            });
            ...
            $('button.button-form-adduser').on('click', function() {
                ...
                if (me.verifyMode == 'verify') {
                    var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Verifikasi Data Perubahan dari risiko ini?');
                    mod.find('button.btn-primary').one('click', function(){
                        me.submitRiskData('verify', addUser);
                    });
                } else {
                    var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin memverifikasi data primer dari risiko ini?');
                    mod.find('button.btn-primary').one('click', function(){
        ...
        submitRiskData: function(submitMode, addUser) {
            ...
            if (fvalid) {
                ...
                if (cnt < 1) {
                    MainApp.viewGlobalModal('error', 'Harap masukan setidaknya satu rencana tindakan untuk risiko ini');
                    return false;
                }
                ...
                } else if (submitMode == 'verifyowned') {
                    ...
                    function( data ) {
                        ...
                        if(data.success) {
                            ...
                            mod.find('button.btn-ok-success').one('click', function(){
                                ...
                                if (submitMode == 'verify' || submitMode == 'verifyowned') {
                                   location.href=site_url+'/main/mainpic';
                                } else {
                                   location.href=site_url+'/main/mainpic';
                                }
