...
var RiskList = function() {
	return {
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					//MainApp.viewGlobalModal('success', 'Berhasil memperbarui Status Risiko');
	        			...
	        			Metronic.unblockUI();
	        			MainApp.viewGlobalModal('error', 'Kesalahan mengiriman Data');
	        		 });
	        	});
	        },
	        ...
	        deleteRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('warning', 'Anda yakin ingin <b> menghapus</b> Risiko : <b>'+data.risk_event+'</b> ?');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					MainApp.viewGlobalModal('success', 'Berhasil Menghaus Risiko');
	        				} else {
	        					MainApp.viewGlobalModal('error', data.msg);
	        				}
	        ...
	        submitRiskPeriode: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Submit ke RAC Semua Risiko dalam Periode : <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
	        ...
	        submitRiskPeriode2: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Permintaan Perubahan kepada RAC All Risk in Periode : <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
