...
var Kri = function() {
	return {
        ...
        //---------------------acntion plan execution
        	...
        	$('#library-modal-add').on('click', function() {
        		...
        		if (selRow.length > 0) {
        			...
        			var mod = MainApp.viewGlobalModal('confirm', 'Tambah Risiko yang Dipilih untuk KRI?');
        				...
        				$.post(
        					...
        					function( data ) {
        						...
        						if(data.success) {
        							...
        							MainApp.viewGlobalModal('success', 'Sukses Mengubah Risiko untuk KRI');
        						} else {
        			...
        			MainApp.viewGlobalModal('error', 'Silahkan Pilih Resiko');
        		}
        	});
        },
        ...
        deleteData: function(data) {
                ...
                var mod = MainApp.viewGlobalModal('warning', 'Apakah Anda yakin ingin menghapus data ini?');
                    ...
                    $.post(
                        ...
                        function(data) {
                            ...
                            if(data.success) {
                                ...
                                MainApp.viewGlobalModal('success', 'Sukses Menghapus Data');
                            } else {
