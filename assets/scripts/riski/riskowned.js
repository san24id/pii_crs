    ...
    return {
        ...
        submitRiskData: function(submitMode) {
            ...
            if (submitMode == 'draft') {
                ...
                var vtext = 'Do you want to save this risk as a Draft?';
            } else {
                ...
                $.post(
                    ...
                    function( data ) {
                        ...
                        if(data.success) {
                            ...
                            //ubah
                            var mod = MainApp.viewGlobalModal('warning-maintenance', 'Risiko ini Sedang Undermaintenance oleh RAC Anda tidak dapat mengubah risiko ini sampai proses selesai');
                            mod.find('button.btn-ok-success').one('click', function(){
                                location.href=site_url+'/main/mainpic';
                            });
                        }
