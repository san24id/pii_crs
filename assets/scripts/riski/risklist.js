...
var RiskList = function() {
	return {
	        ...
	        init: function() {
    	        ...
    	        $('#button-save-submit').click(function(e) {
      			...
      			$('#button-alert-submit').on('click', function() {
        			var mod = MainApp.viewGlobalModal('alert', 'Untuk Submit Risiko yang Teridentifikasi pada Periode Ini, mohon konfirmasi atau hapus data pada Roll Forward Risk');
        		});
	        ...
	        confirmRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin Roll Forward risiko ini ke periode saat ini,<br>Untuk Risiko : <b>'+data.risk_event+'</b> ? ');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					MainApp.viewGlobalModal('success', 'Sukses Update Status Risiko');
	        				} else {
	        					MainApp.viewGlobalModal('error', data.msg);
	        				}
	        ...
	        deleteRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('warning', 'Apakah Anda yakin ingin <b>Hapus</b> Risiko : <b>'+data.risk_event+'</b> ?');
	        ...
	        submitRiskPeriode2: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin meminta perubahan ke RAC semua risiko yang teridentifikasi dalam periode : <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
