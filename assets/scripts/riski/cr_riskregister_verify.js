 ...
 $('#modal-control-filter-submit').on('click', function() {
            ...
            */
            ...
            $('#primary-risk-button-submit').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Verifikasi Permintaan Perubahan dengan Data Primer ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-set-as-primary').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Mengatur Perubahan Data menjadi Primer ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-button-submit').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Verifikasi Permintaan Perubahan dengan Data Perubahan ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-button-save').on('click', function() {
                ...
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Menyimpan Perubahan Permintaan Perubahan Anda ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-button-cancel').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin membatalkan Ubah Permintaan Verifikasi Anda? Anda akan kehilangan data yang belum disimpan.');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
...
g_username = data_risk['risk_input_by'];
        ...
        submitRiskData: function(mode) {
            ...
            if (fvalid) {
                ...
                if(suggested_rt != 'ACCEPT'){
                    if (cnt < 1) {
                         MainApp.viewGlobalModal('error', 'Harap masukan setidaknya satu Action Plan untuk risiko ini');
                         return false;
                    }
                }
