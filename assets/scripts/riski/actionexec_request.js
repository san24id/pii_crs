var ActionVerify = function() {
	return {
		init: function() {
            ...
            $('#exec-button-submit-prior').on('click', function () {
                    me.submitRiskData_prior('verify');
            });
        ...
        submitRiskData: function(submitMode) {
        	...
        	if (fvalid) {
            	...
            	var url = site_url+'/main/mainpic/RequestActionExe';
            	
            	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda yakin ingin Mengubah Permintaan Action Plan Execution ini?');
            	...
            	mod.find('button.btn-primary').one('click', function(){
            		...
            		$.post(
            			...
            			function( data ) {
            				Metronic.unblockUI();
            				if(data.success) {
            					var mod = MainApp.viewGlobalModal('success', 'Sukses Meminta Perubahan Action Plan anda');
        ...
        submitRiskData_prior: function(submitMode) {
            var form1 = $('#input-form').validate();
            var fvalid = form1.form();
            if (fvalid) {
                var me = this;
                ...
                var url = site_url+'/main/mainpic/RequestActionExePrior';
        ...
        submitRiskDataNo: function(submitMode) {
            ...
            if (fvalid) {
                ...
                var url = site_url+'/main/mainrac/RequestActionExe';
