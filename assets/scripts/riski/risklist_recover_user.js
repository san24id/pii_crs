...
var RiskList = function() {
	return {
	        ...
	        confirmRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Yakin ingin <b> Restore </ b> risiko ini ke Risk Register Anda, untuk risiko : <b>'+data.risk_event+'</b> ? ');
	        ...
	        deleteRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('warning', 'Anda yakin akan <b> Menghapus </ b> risiko: <b>'+data.risk_event+'</b> ?');
	        ...
	        submitRiskPeriode: function() {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Apakah Anda ingin Submit ke RAC semua Risk Identified in Periode: <b>'+g_p_name+'</b>');
	        	mod.find('button.btn-ok-success').one('click', function(){
	        		mod.modal('hide');
