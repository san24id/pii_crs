...
gridCataVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataVLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridCataLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataLow" // ajax source
        },
        "columnDefs": [ {
            "targets": 0,
            "data": "risk_code",
...
gridCataMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataMed" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridCataHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridCataVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataVHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMayVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayVLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMayLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMayMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayMed" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMayHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMayVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayVHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridModVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModVLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridModLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridModMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModMed" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridModHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridModVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModVHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMinVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinVLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMinLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMinMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinMed" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMinHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridMinVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinVHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridInsVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsVLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridInsLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsLow" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridInsMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsMed" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridInsHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
...
gridInsVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsVHigh" // ajax source
        },
        "columnDefs": [{
            "targets": 0,
            "data": "risk_code",
