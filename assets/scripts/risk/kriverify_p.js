	...
	return {
        ...
        init: function() {
        	...
        	$('#kri-button-cancel').on('click', function() {
        		...
        		mod.find('button.btn-primary').one('click', function(){
        			location.href=site_url+'/main/mainrac/priorkri';
        		});
        	}); 
			...
			$('#input-form-likelihood-button').on('click', function() {
        		...
        		$('#risk_likelihood_key_after_kri').val(res[1]);
        	...
        	if (fvalid) {
        		...
        		$.post(
        			url,
        			{
						...
						'risk_likelihood_key_after_kri' : $('#risk_likelihood_key_after_kri').val().toUpperCase(),
        ...
        saveRiskDataKRI: function() {
                ...
                if (fvalid) {
                        ...
                        Metronic.blockUI({ boxed: true });
                        var url = site_url+'/risk/kri/saveKri';
                        var k_id = $('#kri-id').val();
                        $.post(
                                url,
                                {
                                ...
                                function( data ) {
                                        ...
                                        if(data.success) {
                                                var mod = MainApp.viewGlobalModal('success', 'Success Updating KRI');
                                                mod.find('button.btn-ok-success').one('click', function(){
                                                        location.href=site_url+'/main/mainrac/viewKriPrior/'+k_id;
                                                });
