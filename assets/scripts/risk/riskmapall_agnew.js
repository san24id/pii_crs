...
gridCataVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataVLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
			{ "data": "risk_event" },
...
gridCataLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridCataMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataMedagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridCataHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridCataVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getCataVHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMayVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayVLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMayLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMayMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayMedagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMayHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMayVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMayVHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridModVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModVLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridModLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridModMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModMedagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridModHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridModVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getModVHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMinVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinVLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMinLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMinMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinMedagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMinHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridMinVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getMinVHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridInsVLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsVLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridInsLow.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsLowagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridInsMed.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsMedagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridInsHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
...
gridInsVHigh.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/main/MainRac/getInsVHighagnew/"+pid // ajax source
        },
        "columnDefs": [  ],
        "columns": [
            { "data": "risk_event" },
