...
return {
        ...
        init: function() {
            ...
            */
            ...
            $('#primary-register_form-button-submit').on('click', function() { 
                var mod = MainApp.viewGlobalModal('confirm', 'Are You sure want to Verify Change Request with Primary Data ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
                     
                    //var mod_det = MainApp.viewGlobalModal('confirm-change', 'Approve will create all risk status to draft?');
                     
                    me.submitRiskData('verifyRegister');
                     
                });
            });

            $('#change-register-button-submit').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Are You sure want to Verify Change Request with Primary Data ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
                    ...
                    me.submitRiskData('verifyRegisterChange');
            ...
            $('#changes-risk-set-as-primary').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Are You sure want to Set the Changes Data to Primary ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-button-submit').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Are You sure want to Verify Change Request with Changes Data ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-button-save').on('click', function() {
                ...
                var mod = MainApp.viewGlobalModal('confirm', 'Are You sure want to Save your Change Request Changes ?');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
            ...
            $('#changes-risk-button-cancel').on('click', function() {
                var mod = MainApp.viewGlobalModal('confirm', 'Are You sure want to cancel your Change Request Verification ? You will loose your unsaved data.');
                mod.find('button.btn-primary').off('click');
                mod.find('button.btn-primary').one('click', function(){
        ...
        submitRiskData: function(mode) {
            ...
            if (fvalid) {
                ...
                if(mode != 'verifyPrimary' || mode!= 'verifyRegister' || mode!= 'verifyRegisterChange'){
                    if (cnt < 1) {
                ...
                var suggested_rt =  $('#suggested_rt').val();
                if(suggested_rt != 'ACCEPT' || mode != 'verifyPrimary' || mode != 'verifyRegister' || mode!= 'verifyRegisterChange'){
                    if (cnt < 1) {
                ...
                if (mode == 'verifyPrimary') {
                    ...
                    var url = site_url+'/main/mainRac/cr_verifyRiskPrimary';
                }else if (mode == 'verifyRegisterChange') {
                    var url = site_url+'/main/mainRac/cr_verifyRiskChanges';
                    ...
                    function( data ) {
                        ...
                        if(data.success) {
                            ...
                            mod.find('button.btn-ok-success').one('click', function(){
                                if (mode == 'verifyPrimary' || mode == 'verify' || mode == 'delete' || mode == 'verifyRegister' || mode == 'verifyRegisterChange') {
