	...
	return {
        ...
        submitRiskData: function(submitMode) {
        	...
        	if (fvalid) {
            	...
            	var mod = MainApp.viewGlobalModal('confirm', 'Are You sure you want to Change Request this Action Plan Execution ?');
            	...
            	mod.find('button.btn-primary').one('click', function(){
            		...
            		$.post(
            			...
            			function( data ) {
            				Metronic.unblockUI();
            				if(data.success) {
            					var mod = MainApp.viewGlobalModal('success', 'Success Change Request your Action Plan');
