    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                ...
                '<button type="button" class="btn btn-default btn-xs" onclick="javascript: RiskInputTransfer.selectLibraryaction('+full.id+')"><i class="fa fa-check-circle font-blue"> Select </i></button>'+
                '</div>';
                return ret;
            }
        },{
...
gridLibrary.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                var ret = '<div class="btn-group">'+
                '<button type="button" class="btn btn-default btn-xs" onclick="javascript: RiskInputTransfer.selectLibrary('+full.risk_id+')"><i class="fa fa-check-circle font-blue"> Select </i></button>'+
                '</div>';
                return ret;
            }
        } ],
...
gridControl.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                var ret = '<div class="btn-group">'+
                '<button type="button" class="btn btn-default btn-xs" onclick="javascript: RiskInputTransfer.selectControlLibrary('+full.id+')"><i class="fa fa-check-circle font-blue"> Select </i></button>'+
                '</div>';
                return ret;
            }
        },{
...
gridControlobjective.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                var ret = '<div class="btn-group">'+
                '<button type="button" class="btn btn-default btn-xs" onclick="javascript: RiskInputTransfer.selectControlLibraryobjective('+full.id+')"><i class="fa fa-check-circle font-blue"> Select </i></button>'+
                '</div>';
                return ret;
            }
        },{
...
gridControlExisting.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
            ...
            "render": function ( data, type, full, meta ) {
                var ret = '<div class="btn-group">'+
                '<button type="button" class="btn btn-default btn-xs" onclick="javascript: RiskInputTransfer.selectControlLibraryexisting('+full.id +')"><i class="fa fa-check-circle font-blue"> Select </i></button>'+
                '</div>';
                return ret;
            }
        } ],
...
var gridDisImpact = new Datatable();
gridDisImpact.init({
    src: $("#dis_impact"),
    onSuccess: function (grid) {
        // execute some code after table records loaded
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/risk/RiskRegister/getDisImpact" // ajax source
        },
...
/* //GAGAL
var gridRiskInputBy = new Datatable();
gridRiskInputBy.init({
    src: $("#risk_input_by"),
    onSuccess: function (grid) {
        // execute some code after table records loaded
    },
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "lengthMenu": [[10], [10]],
        "ajax": {
            "url": site_url+"/risk/RiskRegister/getRiskInputBy" // ajax source
        },
        "columnDefs": [ {
            
        } ],
        "columns": [
            { "data": "risk_id","orderable": true }
       ],
        "order": [
            [0, "asc"]
        ]// set first column as a default sort by asc
...
var handleValidationControl = function() {
    var form1 = $('#primary-input-form-control');
...
var handleValidationObjective = function() {
    var form1 = $('#primary-input-form-control-objective');
...
var handleValidationAction = function() {
    ...
    var form1 = $('#primary-input-form-action-plan');
    //var error1 = $('.alert-danger', form1);
    //var success1 = $('.alert-success', form1);
...
var RiskInputTransfer = function() {
    return {
        dataMode: null,
        ...
        init: function(mode) {
            ...
            $('#primary-input-form-likelihood-button').on('click', function() {
                var sel = $('#form-likelihood input[name=risk_likelihood]:checked').val();
                var res = sel.split('|');
                
                $('#primary-input-form input[name=risk_likelihood_id]').val(res[0]);
                $('#primary-input-form input[name=risk_likelihood_value]').val(res[1]);
            ...
            $('#input-control-add').on('click', function() {
                var form1 = $('#primary-input-form-control').validate();
                var fvalid = form1.form();
                 
                if (fvalid) {
                    var xcid = $('#primary-input-form-control input[name=control_id]').val();
                    var xeid = $('#primary-input-form-control input[name=ec_id]').val();
                    var xexis = $('#primary-input-form-control textarea[name=risk_existing_control]').val();
                    var xeval = $('#primary-input-form-control input[name=risk_evaluation_control]').val();
                    var xowner = $('#primary-input-form-control select[name=risk_control_owner]').val();
                    var xdiv = $('#primary-input-form-control input[name=control_owner]').val();
            ...
            $('#input-control-add-objective').on('click', function() {
                var form1 = $('#primary-input-form-control-objective').validate();
                var fvalid = form1.form();
                 
                if (fvalid) {
                    var xcid = $('#primary-input-form-control-objective input[name=objective_id]').val();
                    var xcobjid = $('#primary-input-form-control-objective input[name=objid]').val();
                    var xexis = $('#primary-input-form-control-objective textarea[name=objective]').val();
            ...
            $('#input-actionplan-add').on('click', function() {
                var form1 = $('#primary-input-form-action-plan').validate();
                var fvalid = form1.form();
                ...
                if (fvalid) {
                    ...
                    var xidap = $('#primary-input-form-action-plan input[name=id_ap]').val();
                    var xplan = $('#primary-input-form-action-plan textarea[name=action_plan]').val();
                    var xdate = $('#primary-input-form-action-plan input[name=due_date]').val();
                    var xdiv_view = $('#primary-input-form-action-plan input[name=division_v]').val();
                    var xdiv_id = $('#primary-input-form-action-plan select[name=division] option:selected').val();
                    var xecs = $('#primary-input-form-action-plan input[name=execution_status]').val();
                    var xece = $('#primary-input-form-action-plan input[name=execution_explain]').val();
                    var xece_vi = $('#primary-input-form-action-plan input[name=execution_evidence]').val();
                    var xecr = $('#primary-input-form-action-plan input[name=execution_reason]').val();
                    var xred = $('#primary-input-form-action-plan input[name=revised_date]').val();
                    var xexe = $('#primary-input-form-action-plan input[name=existing_control_id]').val();
            ...
            $('#primary-input-form-impact-button').on('click', function() {
                var imp_1 =  $('#imp_1').val();
                var imp_2 =  $('#imp_2').val();
                var imp_3 =  $('#imp_3').val();
                var imp_4 =  $('#imp_4').val();
                ...
                if (all_na) {
                    ...
                    $('#primary-input-form input[name=risk_impact_level_id]').val(max_val);
                    $('#primary-input-form input[name=risk_impact_level_value]').val(xv);
            ...
            $('#button-form-control-open').on('click', function () {
                ...
                //$('#primary-input-form-action-plan').reset();
                document.getElementById("primary-input-form-control2").reset();
                document.getElementById("primary-input-form-control").reset();
                 
                $('#form-control-revid').val("");
                $('#primary-input-form-control textarea[name=risk_existing_control]').attr('readonly', false);
                
            });

            /*
            $('#button-form-control-open').on('click', function () {
                //$('#primary-input-form-control')[0].reset();
            ...
            */
            ...
            $('#button-form-control-open-objective').on('click', function () {
                document.getElementById("primary-input-form-control-objective").reset();
               // $('#primary-input-form-control-objective')[0].reset();
                $('#form-control-revid-objective').val("");
                $('#primary-input-form-control-objective text[name=objid]').attr('readonly', false);
                $('#primary-input-form-control-objective textarea[name=objective]').attr('readonly', false);
            });
            
            $('#button-form-data-open').on('click', function () {
                
                //$('#primary-input-form-action-plan').reset();
                document.getElementById("primary-input-form-action-plan").reset();
                $('#fdate').show();
                $("#checked").hide();
                $('#ckc').show();
                $('#kcc').hide();
            ...
            $('#input-control-add-3').on('click', function() {
                    ...
                    var form1 = $('#primary-input-form-control-3').validate();
                    var fvalid = form1.form();
                 
                    if (fvalid) {
                    var xcid = $('#primary-input-form-control-3 input[name=control_id_n]').val();
                    var xeid = $('#primary-input-form-control-3 input[name=ec_id_n]').val();
                    var xexis = $('#primary-input-form-control-3 input[name=risk_existing_control_n]').val();
                    var xeval = $('#primary-input-form-control-3 input[name=risk_evaluation_control_n]').val();
                    var xowner = $('#primary-input-form-control-3 input[name=risk_control_owner_n]').val();
                    var xdiv = $('#primary-input-form-control-3 input[name=control_owner_n]').val();
        ...
        setRiskLevel: function() {
            var iv = $('#primary-input-form input[name=risk_impact_level_id]').val();
            var lv = $('#primary-input-form input[name=risk_likelihood_id]').val();
            //console.log(iv, lv);
            var xv = iv+"-"+lv;
            if (this.riskLevelList[xv] != undefined) {
                var vv = this.riskLevelReference[this.riskLevelList[xv]];
                $('#primary-input-form input[name=risk_level_id]').val(this.riskLevelList[xv]);
                $('#primary-input-form input[name=risk_level]').val(vv);
            }
        },
        ...
        controlAddRow: function(nnode) {
            ...
            $('#primary_control_table > tbody:last-child').append('<tr id = "tr_c'+me.dataControlCounter+'">'+
        ...
        controlAddRowobjective: function(nnode) {
            ...
            $('#primary_objective_table > tbody:last-child').append('<tr id = "'+me.dataControlCounterobjective+'">'+
        ...
        actionPlanAddRow: function(nnode) {
            ...
            $('#primary_action_plan_table > tbody:last-child').append('<tr id = "tr_z'+me.dataActionPlanCounter+'">'+
        ...
        selectControlLibrary: function(rid) {
            var me = this;
            $('#primary-input-form-control textarea[name=risk_existing_control]').attr('readonly', false);
            $('#primary-input-form-control text[name=ec_id]').attr('readonly', false);
            ...
            $.getJSON( site_url+"/risk/RiskRegister/loadControlLibrary/"+rid, function( data_risk ) {
                ...
                me.populateRisk($('#primary-input-form-control'), data_risk);
            });
        },
        selectControlLibraryobjective: function(rid) {
            ...
            $.getJSON( site_url+"/risk/RiskRegister/loadControlLibraryobjective/"+rid, function( data_risk ) {
                ...
                me.populateRisk($('#primary-input-form-control-objective'), data_risk);
            });
        },
        selectControlLibraryexisting: function(rid) {
            var me = this;
            $('#primary-input-form-control input[name=risk_evaluation_control]').attr('readonly', true);
         ...
         selectLibraryaction: function(rid) {
            ...
            $.getJSON( site_url+"/risk/RiskRegister/loadactionLibrary/"+rid, function( data_risk ) {
                ...
                me.populateRisk($('#primary-input-form-action-plan'), data_risk);
            });
