		...
		<div class="col-md-12">
			...
			<div class="form-body">
				...
				<label class="col-md-2 control-label"></label>
					<div class="col-md-6">
						<span style="color:#035CFF"><p align="left"><i>*If you want to change the treshold type. This will delete all previous treshold</i></p></span>
					</div>
				</div>
				<div class="form-group">	
				...
				<div class="form-group">
				<label class="col-md-2 control-label" title="">Respons</label>
				<div class="col-md-6">		
