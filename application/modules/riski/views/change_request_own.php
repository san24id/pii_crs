...
<div class="page-content-wrapper">
				...
				<div class="portlet-body form">
						...
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-9">
								<input type="hidden" class="form-control input-sm" readonly="true" name="risk_code" placeholder="">
	...
	?>
		...
		<div class="col-md-12">
			...
			<p>
				<a class="btn red" target="_self" href="<?=$site_url?>/main/mainpic#tab_owned">
				Back</a>
			</p>
			</div>
		</div>
