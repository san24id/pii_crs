...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="javascript:;">Register Berkala</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a target="_self" href="<?=$site_url?>/riski/RiskRegister">Risk Register Berkala</a>
				</li>
			</ul>
	...
	<div class="col-md-12">
		<div class="note note-warning">
			...
			<h4 class="block">Peringatan</h4>
			<p>
				 Anda tidak dapat memasukkan Regular Risk Register karena Periode Pendaftaran Reguler Ditutup, silahkan hubungi RAC untuk informasi lebih lanjut.
			</p>
			<p>
				<a class="btn red" target="_self" href="<?=$site_url?>/maini">
				Kembali ke Beranda </a>
	...
	<div class="col-md-12">
		<div class="note note-warning">
			...
			-->
				...
				Warning !
Tidak dapat mengirimkan daftar risiko karena Anda sudah pernah mengirimkan risiko ini.
				 <p>
