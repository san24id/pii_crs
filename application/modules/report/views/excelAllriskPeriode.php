...
header("Content-Disposition: attachment; filename=daftar_All_risk_periode". date('dmY_His').".xls" );
header("Expires: 0");
...
$worksheet1->write_string(4,1,'2nd Sub Category',$header);  // Set Nama kolom
$worksheet1->set_column(0,2,50); // Set lebar kolom 
$worksheet1->write_string(4,2,'Risk ID',$header);  // Set Nama kolom
$worksheet1->set_column(0,2,20); // Set lebar kolom
$worksheet1->write_string(4,3,'Risk Event',$header);  // Set Nama kolom
$worksheet1->set_column(0,3,50); // Set lebar kolom
$worksheet1->write_string(4,4,'Risk Description',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,5,'Risk Owner',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,6,'Cause',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,7,'Impact',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,8,'Existing Control',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,9,'Control Owner',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,10,'Control Evaluation',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,11,'Impact Level',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,12,'Likelihood Level',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,13,'Risk Level',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
