	...
	<div class="page-content">
			...
			<div class="form">
				<form class="form-horizontal">		
					<div class="form-group">
						<label class="col-md-3 control-label">Report Option</label>
							<div class="col-md-6">
								<select class="form-control input-sm" id="typereport">
									<option value="-">Choose</option>
									<option value="excel">All Risk</option>
									<option value="pdf">By Date</option>
		<!-- 							<option value="word">MS. Word</option> -->
			...
			<div class="form" id="forexcel">
				<form target="_self" action="<?=$site_url?>/report/risk/getallrisk2" method="post" id="input-form" role="form" class="form-horizontal">
					<div class="form-body">
			...
			<div class="form" id="forpdf">
				<form target="_self" action="<?=$site_url?>/report/risk/getallrisk3" method="post" id="input-form" role="form" class="form-horizontal">
					<div class="form-body">
