...
header("Content-Disposition: attachment; filename=daftar_risk_treatment". date('dmY_His').".xls" );
header("Expires: 0");
...
$worksheet1->write_string(0,4,'Risk Treatment',$title);  // Set Nama kolom
...
$worksheet1->write_string(4,1,'Risk ID',$header);  // Set Nama kolom
...
$worksheet1->write_string(4,3,'Risk Owner',$header);  // Set Nama kolom
$worksheet1->set_column(0,2,20); // Set lebar kolom
$worksheet1->write_string(4,4,'Impact Level',$header);  // Set Nama kolom
$worksheet1->set_column(0,3,50); // Set lebar kolom
$worksheet1->write_string(4,5,'Likelihood Level',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,6,'Risk Level',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,7,'Implementation',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,8,'Action Plan',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,9,'Due Date',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
$worksheet1->write_string(4,10,'Action Plan Owner',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,50); // Set lebar kolom
...
if($rows>0){
	if($i < $rows){
		foreach ($data as $key) {
		    ...
		    $worksheet1->write_string($row,3,  $key->risk_owner ,$content);
		    $worksheet1->write_string($row,4,  $key->risk_impact_level ,$content);
		    $worksheet1->write_string($row,5,  $key->risk_likelihood_key ,$content);
		    $worksheet1->write_string($row,6,  $key->risk_level ,$content);
		    $worksheet1->write_string($row,7,  $key->suggested_risk_treatment ,$content);
		    $worksheet1->write_string($row,8,  $key->action_plan ,$content);
		    $worksheet1->write_string($row,9,  $key->due_date ,$content);
		    $worksheet1->write_string($row,10,  $key->division ,$content);
		    $row++;
		    $i++;
		}	
