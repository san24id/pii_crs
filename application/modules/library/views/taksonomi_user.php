		...
		<div class="tabbable-custom ">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab_risk_list">
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_taksonomiuser_list">
						<div class="form-group">
							<label for="filterFormBy" class="smaller">Filter By : </label>
							<select class="form-control input-medium input-sm" id="tab_taksonomi_user_list-filterBy">
								<option value="cat_name">Name</option>
								<option value="cat_desc">Description</option>
							</select>
						</div>
						<div class="form-group">
							<input type="text" class="form-control input-sm" placeholder="Search" id="tab_taksonomi_user_list-filterValue">
						</div>
						<button type="submit" class="btn blue btn-sm" id="tab_taksonomiuser_list-filterButton">Search</button>
					</form>
						<table class="table table-condensed table-bordered table-hover " id="datatabletaxuser_ajax">
						<thead>
