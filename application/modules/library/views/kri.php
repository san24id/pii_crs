					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_kri_list">
						<div class="form-group">
							...
							<select class="form-control input-medium input-sm" id="tab_kri_list-filterBy">
								<option value="key_risk_indicator">KRI Name</option>
								<option value="mandatory">Mitigation</option>
							</select>
						</div>
						...
						<button type="submit" class="btn blue btn-sm" id="tab_kri_list-filterButton">Search</button>
					</form>
						...
						<tr role="row" class="heading">
							...
							<th><center>KRI Name</center></th> 
							<th><center>Mitigation</center></th> 
							<th><center>Threshold Type</center></th> 
	...
	<div class="modal-body">
				<form id="modal-listrisk-form" role="form" class="form-horizontal">
					<div class="form-body">
						...
						<label class="col-md-3 control-label smaller cl-compact">Mitigation :</label>
							<div class="col-md-9">
