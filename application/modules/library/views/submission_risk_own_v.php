...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		?>
			Submission Confirmation For Risk Owner <?php echo $query->periode_name; ?>
		</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li class="bread_tab">
					<a id="bread_tab_title" target="_self" href="javascript:;">Submission Confirmation For Risk Owner</a>
				</li>
			</ul>
			<div class="page-toolbar">
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu pull-right" role="menu">
						<li>
							<a href="<?=$site_url?>/library/submission_riskown_pdf/<?php echo $id_period ?>" id="">PDF</a>
						</li>
						<li>
							<a href="<?=$site_url?>/library/submission_riskown_excel/<?php echo $id_period ?>" id="">Excel</a>
						</li>					 
					</ul>
				</div>
			</div>
 	...
 	<!-- Modal -->
		...
		<div class="tabbable-custom ">
			...
			<div class="tab-content">
				<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_risk_owned" >
						<div class="form-group">
							<label for="filterFormBy" class="smaller">Filter By : </label>
							<select class="form-control input-medium input-sm" id="tab_risk_owned-filterBy">
						...
						<div class="form-group" id="choose_status_date_own">
							<select class="bish form-control input-medium input-sm" id="s_date_own">
						...
						<div class="form-group" id="choose_l_divisi_own">
						<select class="besh form-control input-sm" id="l_divisi_own">
							<option value="">All</option>
						...
						<div class="form-group" id="ni">
							<input type="text" class="form-control input-sm" placeholder="Search" id="tab_risk_owned-filterValue">
						</div>
						<button type="submit" class="btn blue btn-sm" id="tab_risk_owned-filterButton">Search</button>
				</form>
				 
					<div ><!--class="table-scrollable"-->
					<input type="hidden" name="periode_id" id="periode_id" value="<?php echo $id_period ?>">
						<table class="table table-condensed table-bordered table-hover " id="datatable_ajax_risk_own">
						<thead>
...
<!--
		<div id="modal-submit-own" class="modal fade" tabindex="-1" data-width="760" data-keyboard="false">
			...
			<div class="modal-body">
				<form id="noteform" role="form" class="form-horizontal" action ="<?=base_url('index.php/main/mainrac/submit_risk_own');?>" method="POST">			 
					...
					<button type="button" class="btn blue btn-sm" onclick = "submit_risk_own()">Save</button>			 
				</form> 
			</div>
		</div>
-->

	<div id="modal-submit-own" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
	...
	<div class="modal-body">
			...
			<form id="noteform_own" role="form" class="form-horizontal">
				<div class="form-body">
					<div class="form-group">
	...
	<div class="modal-footer">
		...
		<button id="edit_note_own" type="button" 
