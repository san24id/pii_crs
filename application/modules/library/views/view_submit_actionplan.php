...
<div class="page-content-wrapper">
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		View Submission Action Plan : <?php 
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li class="bread_tab">
					<a id="bread_tab_title" target="_self" href="<?=$site_url?>/library/submission_risk_owner">Head Confirmation For Action Plan</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li class="bread_tab">
			...
			<div class="page-toolbar">
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu pull-right" role="menu">
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/library/viewConfirmActionPlanHead_excel/$filled_by_id");?>">Excel</a>
						</li>
