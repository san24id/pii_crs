	...
	<div class="page-content">
		...
		<div class="col-md-12">
			...
			<div class="portlet-body form">
				...
				<?php } ?>
				<form target="_self" action="<?=$site_url?>/admin/policy/newsInsertData" enctype="multipart/form-data" method="post" id="input-form" role="form" class="form-horizontal">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Upload policy Content</label>
							<div class="col-md-6">
