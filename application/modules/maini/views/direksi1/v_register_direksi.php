...
<div class="page-content-wrapper">
  <div class="page-content">
    <!-- BEGIN PAGE HEADER-->
    <h3 class="page-title">
    Dashboard - Chief Executive Officer as Director of Directorate
    </h3>
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <i class="fa fa-home"></i>
          <a target="_self" href="<?=$site_url?>/maini/maindireksi">Beranda</a>
          ...
          <div class="#modal-dialog" role="document" >
            <div class="modal-content" >
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Daftar Risiko Export - choose field to export</h4>
              </div>
              <div class="modal-body">
                <form id = "get_check_risklist">
                    <tr role="row" class="heading">
                        ...
                        <th>Dampak Risiko <input type = "checkbox" checked="true"  name = "risk_level_v" ></th>
        ...
        <div class="modal fade" data-width="650" id="modal-executionlist" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Pelaksanaan Action Plan List Export - choose field to export</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" data-width="650" id="modal-kri" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Daftar KRI Export - choose field to export</h4>
              </div>
              <div class="modal-body">
                <form id = "get_check_kri">
                    <tr role="row" class="heading">
                        <th width="30px">Status <input type = "checkbox" checked="true"  name = "kri_status" ></th>
                        <th>ID KRI <input type = "checkbox" checked="true"  name = "kri_code"  > </th>
        ...
        <div class="modal fade" data-width="650" id="modal-changereq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Permintaan Perubahan List Export - choose field to export</h4>
              </div>
              <div class="modal-body">
            ...
            <div class="info-box-content bg-purple">
              ...
              <table width="100%">
                  <tr>
                    ...
                    <td align="right" width="70%"> <img src="assets/images/up-xxl-w.png" width="40" height="50"/></td>
                        <td align="right" width="35%"><span style="font-weight: bold; font-size: 42px;"><?php echo $AP_total_cur_CEO;?></span></td>
                    
                  </tr>
                  <tr><td align="right" colspan="2"><span style="font-weight: bold; font-size: 16px; color: black;"><?php echo "TOTAL ACTION PLAN"; ?></span></td></tr>
                  <tr>
                    <td align="right" colspan="2"> <span style="font-weight: bold; font-size: 16px;"><?php echo "Prior: "; ?></span>
                        <span style="font-weight: bold; font-size: 21px;"><?php echo $AP_total_prior_CEO; ?></span></td>
                  </tr>
              </table>
            </div>
          </div>
          ...
          <div class="info-box" style="border: 3px solid #fff;">
            ...
            <table width="100%">
                  ...
                  <tr>
                    ...
                    <td align="center"><font size="+1"><?php echo $AP_complete_cur_CEO;?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_complete_prior_CEO; ?></font></td>
                  </tr>
                  <tr>
                    <td width="30%">Sedang Berjalan</td>
                    <td align="center"><font size="+1"><?php echo $AP_ongoing_cur_CEO; ?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_ongoing_prior_CEO; ?></font></td>
                  </tr>
                  <tr>
                    <td width="30%">Diperpanjang</td>
                    <td align="center"><font size="+1"><?php echo $AP_extend_cur_CEO; ?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_extend_prior_CEO; ?></font></td>
                  </tr>
                  <tr>
                    <td></td>
          ...
          <div class="info-box" style="border: 3px solid #fff;">
            ...
            <div class="info-box-content bg-aqua">
              <table width="100%">
                  <tr><td>&nbsp;</td></tr>
                <tr>
                  <td rowspan="5" width="40%"><center><span style="font-weight: bold; font-size: 46px;"><?php echo $AP_kri_prior_CEO;?></span><br />TOTAL KRI</center></td>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/kri_red.png" width="15" /></td><td width="10%">Red</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_red_prior_CEO;?></font></td>
                  </tr>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/treatment.png" width="15" /></td><td width="10%">Yellow</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_yellow_prior_CEO;?></font></td>
                  </tr>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/kri_green.png" width="15" /></td><td width="10%">Green</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_green_prior_CEO;?></font></td>
                  </tr>
                  <tr>
  ...
  <div class="center-container">
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
           ...
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
            <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksiceo/indexceo_risk_dasboard.php"></object>
            </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
            <div style="background-color:#A9A9A9; border: 7px #999999 solid;"> <p style="color:white;  font-size: 18px; margin: 5px 15px 5px 5px;" align="right"><b>RISIKO IIGF - Dikelola oleh Divisi</b></div>
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
           <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/pii_pie2/dasboardceo_risk.php" ></object>
      </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
           ...
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
           <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksiceo/indexceo_apex_dashboard.php"></object>
           </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
           ...
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
           <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksiceo/indexceo_kri_dashboard.php"></object>
           </div>
      </div>
    </div>
  ...
  <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-8" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px;">
             ...
             <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksiceo/indexceo_risk_tab2.php"></object>
              </div>
          </div>
          <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-md-7">
            <div class="row">
              <div class="col-md-12"> 
                  <form class="form-inline" method="post" id="risk_divisi-form" autoSelesai="off">
                      <div class="form-group">
                          <label for="filterFormBy" class="smaller"><font color="#000">Filter Berdasarkan : </font> </label>
        ...
        <form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_risk_list" >
            <div class="form-group">
              ...
              <select class="form-control input-medium input-sm" id="tab_risk_list-filterBy">
                ...
                <option value="risk_impact_level">Dampak Risiko</option>
                  ...
                  <table class="table table-condensed table-bordered table-hover" style="color: #000" id="datatable_ajax">
                    <thead>
                      <tr role="row" class="heading">
                        ...
                        <th><center>Dampak Risiko</center></th>
          ...
          <div class="row" style="margin-top: 15px;">
              <div class="col-md-12">
                 <font color="#000"><h4>Keterangan</h4></font>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/direksiceo_risk.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px; padding-top: 10px;">
                ...
                <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>RISIKO IIGF - Berdasarkan Status Risiko</b></div>
                 <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>SEMUA DIVISI</b></center></span></div>
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object align="center" frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/indexstCeo.php" style="border: 0px solid;" width="100%" height="290"></object>
                </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-12" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px">
              ...
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksiceo/indexceo_kri_tab4.php"></object>
              </div>
          </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-7">
            <div class="row">
              <div class="col-md-12"> 
                   <form class="form-inline" method="post" id="kri_divisi-form" autoSelesai="off">
                      <div class="form-group">
                          <label for="filterFormBy" class="smaller"><font color="#000">Filter Berdasarkan : </font> </label>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>SEMUA DIVISI</b></center></span></div>
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/indexkriceo.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
    ...
    <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-12" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px">
              ...
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksiceo/indexceo_apex_tab3.php"></object>
              </div>
          </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-7">
            <div class="row">
              <div class="col-md-12"> 
                 <form class="form-inline" method="post" id="plan_divisi-form" autoSelesai="off">
                      <div class="form-group">
                          <label for="filterFormBy" class="smaller"><font color="#000">Filter Berdasarkan : </font> </label>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>SEMUA DIVISI</b></center></span></div>
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/direksiapex_ceo.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
