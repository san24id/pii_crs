					...
					<form id="primary-input-form" role="form" class="form-horizontal">
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								<textarea class="form-control input-sm input-readview" readonly="true" rows="3" name="risk_event" placeholder=""></textarea>
								</div>
							</div>
			...
			<form id="input-form-action-plan" role="form" class="form-horizontal">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9"><input type="button" style="width: 20px; height: 20px;" onclick="Check()" id="ckc" />
