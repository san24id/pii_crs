			...
			<form id="input-form-control-3" role="form" class="form-horizontal">
				<div class="form-body">
					<div class="form-group">
								...
								<input type="hidden" class="form-control input-sm" readonly="true" name="existing_control_id" id = "existing_control_id_3" placeholder="">
								<input type = "hidden" id = "form-control-revid-3">
								<input type="hidden" class="form-control input-sm" readonly="true" name="risk_existing_control" id = "risk_existing_control_3" placeholder="" value="Not Available">
								<input type="hidden" class="form-control input-sm" value="Not Available" name="risk_evaluation_control" id = "risk_evaluation_control_3" placeholder="">
								<select style="display:none;" name="risk_control_owner" id = "risk_control_owner_3">
