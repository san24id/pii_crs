...
<div class="page-content-wrapper">
  <div class="page-content">
    <!-- BEGIN PAGE HEADER-->
    <h3 class="page-title">
    Dashboard - Chief Operating Officer as Director of Directorate
    </h3>
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <i class="fa fa-home"></i>
          <a target="_self" href="<?=$site_url?>/maini/maindireksicoo">Beranda</a>
          ...
          <div class="#modal-dialog" role="document" >
            <div class="modal-content" >
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Daftar Risiko Export - Pilih Kolom yang akan diexport</h4>
              </div>
            ...
            <div class="info-box-content bg-purple">
              ...
              <table width="100%">
                  <tr>
                    ...
                    <td align="right" width="70%"> <img src="assets/images/up-xxl-w.png" width="40" height="50"/></td>
                        <td align="right" width="35%"><span style="font-weight: bold; font-size: 42px;"><?php echo $AP_total_cur_COO;?></span></td>
                    
                  </tr>
                  <tr><td align="right" colspan="2"><span style="font-weight: bold; font-size: 16px; color: black;"><?php echo "TOTAL ACTION PLAN"; ?></span></td></tr>
                  <tr>
                    <td align="right" colspan="2"> <span style="font-weight: bold; font-size: 16px;"><?php echo "Prior: "; ?></span>
                        <span style="font-weight: bold; font-size: 21px;"><?php echo $AP_total_prior_COO; ?></span></td>
                  </tr>
              </table>
            </div>
          </div>
          ...
          <div class="info-box" style="border: 3px solid #fff;">
            ...
            <table width="100%">
                  ...
                  <tr>
                    ...
                    <td align="center"><font size="+1"><?php echo $AP_complete_cur_COO;?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_complete_prior_COO; ?></font></td>
                  </tr>
                  <tr>
                    <td width="30%">Sedang Berjalan</td>
                    <td align="center"><font size="+1"><?php echo $AP_ongoing_cur_COO; ?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_ongoing_prior_COO; ?></font></td>
                  </tr>
                  <tr>
                    <td width="30%">Diperpanjang</td>
                    <td align="center"><font size="+1"><?php echo $AP_extend_cur_COO; ?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_extend_prior_COO; ?></font></td>
                  </tr>
                  <tr>
                    <td></td>
          ...
          <div class="info-box" style="border: 3px solid #fff;">
            ...
            <div class="info-box-content bg-aqua">
              <table width="100%">
                  <tr><td>&nbsp;</td></tr>
                <tr>
                  <td rowspan="5" width="40%"><center><span style="font-weight: bold; font-size: 46px;"><?php echo $AP_kri_prior_COO;?></span><br />TOTAL KRI</center></td>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/kri_red.png" width="15" /></td><td width="10%">Red</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_red_prior_COO;?></font></td>
                  </tr>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/treatment.png" width="15" /></td><td width="10%">Yellow</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_yellow_prior_COO;?></font></td>
                  </tr>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/kri_green.png" width="15" /></td><td width="10%">Green</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_green_prior_COO;?></font></td>
                  </tr>
                  <tr>
  ...
  <div class="center-container">
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
           ...
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
            <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicoo/indexcoo_risk_dasboard.php"></object>
            </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
        ...
        <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
           <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/pii_pie2/dasboardcoo_risk.php" ></object>
      </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
           ...
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
           <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicoo/indexcoo_apex_dashboard.php"></object>
           </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
           ...
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
           <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicoo/indexcoo_kri_dashboard.php"></object>
           </div>
      </div>
    </div>
  ...
  <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-8" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px;">
              ...
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicoo/indexcoo_risk_tab2.php"></object>
              </div>
          </div>
          <div class="col-md-4">
             <div class="col-md-12 bg-aqua" style="height: 305px; padding: 0px;">
                  ...
                  <div class="col-md-9" style="padding-top: 15px;">
                      ...
                      <table style="font-size: 15px;">
                         <tr>
                          <td colspan="2" align="right"><p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="center"><b>KATEGORI LIMA RISIKO TERATAS<hr></b></td>
                        </tr>
                        <tr>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/direksicoo_risk.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px; padding-top: 10px;">
                ...
                <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>RISIKO IIGF - Berdasarkan Status Risiko</b></div>
                 <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>Semua Divisi</b></center></span></div>
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object align="center" frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/indexstCoo.php" style="border: 0px solid;" width="100%" height="290"></object>
                </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-12" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px">
              ...
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicoo/indexcoo_kri_tab4.php"></object>
              </div>
          </div>
      </div>
    </div>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>Semua Divisi</b></center></span></div>
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/indexkricoo.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
    ...
    <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-12" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px">
              ...
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicoo/indexcoo_apex_tab3.php"></object>
              </div>
          </div>
      </div>
    </div>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>Semua Divisi</b></center></span></div>
                 <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/direksiapex_coo.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
