...
<?php if($divisi == '-' || $divisi == ''){ ?>
            ...
            <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>KRI - by KRI Waring</b></div>
             <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>ALL Division</b></center></span></div>
							<object style="display: none;" align="center" frameborder="no" name="frame1" scrolling="no" data="<?php echo base_url(); ?>/index.php1/pii_pie2/direksirac_risk.php" style="border: 0px solid;" width="100%" height="290"></object>
							                      <!--dummy-->
...
?>
	...
	?>
            ...
            <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>KRI - by KRI Waring</b></div>
             <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b><?php echo $row->division_name; ?></b></center></span></div>
							<object style="display: none;" align="center" frameborder="no" name="frame1" scrolling="no" data="<?php echo base_url(); ?>/index.php1/pii_pie2/direksirac_risk_div.php?div=<?php echo $divisi; ?>" style="border: 0px solid;" width="100%" height="290"></object>
							                      <!--dummy-->
                        <div style="width: 100%; height: 290px"></div>
                      <!---->
					</div>
