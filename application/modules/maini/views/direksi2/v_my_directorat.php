...
<div class="page-content-wrapper">
  <div class="page-content">
    <!-- BEGIN PAGE HEADER-->
    <h3 class="page-title">
    Dashboard - Chief Financial as Director of Directorate
    </h3>
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <i class="fa fa-home"></i>
          <a target="_self" href="<?=$site_url?>/maini/maindireksicfo">Beranda</a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li class="bread_tab">
          <a id="bread_tab_title" target="_self" href="javascript:;">Daftar Risk</a>
        </li>
      </ul>
          ...
          <div class="#modal-dialog" role="document" >
            <div class="modal-content" >
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Export Daftar Risk - Pilih Kolom yang akan diexport</h4>
              </div>
        ...
        <div class="modal fade" data-width="650" id="#modal-export-risk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Risk Register List Export - Pilih Kolom yang akan diexport</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" data-width="650" id="modal-export-treatment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Treatment List Export - Pilih Kolom yang akan diexport</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" data-width="650" id="modal-actionplanlist" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Action Plan List Export - Pilih Kolom yang akan diexport</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" data-width="650" id="modal-executionlist" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Pelaksanaan Action Plan List Export - Pilih Kolom yang akan diexport</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" data-width="650" id="modal-kri" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Daftar KRI Export - Pilih Kolom yang akan diexport</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" data-width="650" id="modal-changereq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="#modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Change Request List Export - Pilih Kolom yang akan diexport</h4>
              </div>
              <div class="modal-body">
            ...
            <div class="info-box-content bg-purple">
              ...
              <table width="100%">
                  <tr>
                    ...
                    <td align="right" width="70%"> <img src="assets/images/up-xxl-w.png" width="40" height="50"/></td>
                        <td align="right" width="35%"><span style="font-weight: bold; font-size: 42px;"><?php echo $AP_total_cur_CFO;?></span></td>
                    
                  </tr>
                  <tr><td align="right" colspan="2"><span style="font-weight: bold; font-size: 16px; color: black;"><?php echo "TOTAL ACTION PLAN"; ?></span></td></tr>
                  <tr>
                    <td align="right" colspan="2"> <span style="font-weight: bold; font-size: 16px;"><?php echo "Prior: "; ?></span>
                        <span style="font-weight: bold; font-size: 21px;"><?php echo $AP_total_prior_CFO; ?></span></td>
                  </tr>
              </table>
            </div>
          </div>
          ...
          <div class="info-box" style="border: 3px solid #fff;">
            ...
            <table width="100%">
                  ...
                  <tr>
                    ...
                    <td align="center"><font size="+1"><?php echo $AP_complete_cur_CFO;?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_complete_prior_CFO; ?></font></td>
                  </tr>
                  <tr>
                    <td width="30%">Sedang Berjalan</td>
                    <td align="center"><font size="+1"><?php echo $AP_ongoing_cur_CFO; ?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_ongoing_prior_CFO; ?></font></td>
                  </tr>
                  <tr>
                    <td width="30%">Diperpanjang</td>
                    <td align="center"><font size="+1"><?php echo $AP_extend_cur_CFO; ?></font></td>
                    <td align="center"><font size="+1">|</font></td>
                    <td align="center"><font size="+1"><?php echo $AP_extend_prior_CFO; ?></font></td>
                  </tr>
                  <tr>
                    <td></td>
          ...
          <div class="info-box" style="border: 3px solid #fff;">
            ...
            <div class="info-box-content bg-aqua">
              <table width="100%">
                  <tr><td>&nbsp;</td></tr>
                <tr>
                  <td rowspan="5" width="40%"><center><span style="font-weight: bold; font-size: 46px;"><?php echo $AP_kri_prior_CFO;?></span><br />TOTAL KRI</center></td>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/kri_red.png" width="15" /></td><td width="10%">Red</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_red_prior_CFO;?></font></td>
                  </tr>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/treatment.png" width="15" /></td><td width="10%">Yellow</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_yellow_prior_CFO;?></font></td>
                  </tr>
                  <tr>
                    <td width="5%"><img src="assets/images/legend/kri_green.png" width="15" /></td><td width="10%">Green</td><td width="20%" align="center"><font size="+1"><?php echo $AP_kri_green_prior_CFO;?></font></td>
                  </tr>
                  <tr>
  ...
  <div class="center-container">
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
            ...
            <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
				<object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicfo/indexcfo_risk_dasboard.php"></object>
            </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
            ...
            <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/pii_pie2/dasboardcfo_risk.php" ></object>
           </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
            <div style="background-color:#A9A9A9; border: 7px #999999 solid;"> <p style="color:white;  font-size: 18px; margin: 5px 5px 5px 15px;" align="left"><b>Pelaksanaan Action Plan - berdasarkan Pelaksanaan</b></div>
           <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
              <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicfo/indexcfo_apex_dashboard.php"></object>
           </div>
      </div>
    </div>
    ...
    <div class="col-xs-6" style="padding:0px 10px 10px 10px">
      <div style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959;">
            <div style="background-color:#A9A9A9; border: 7px #999999 solid;"> <p style="color:white;  font-size: 18px; margin: 5px 15px 5px 5px;" align="right"><b>Indikator Key Risk (KRI) - berdasarkan KRI Warning </b></div>
            <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
               <object width="100%" height="520" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicfo/indexcfo_kri_dashboard.php"></object>
           </div>
      </div>
    </div>
  ...
  <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-8" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px;">
              ...
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                  <object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicfo/indexcfo_risk_tab2.php"></object>
              </div>
          </div>
          <div class="col-md-4">
              ...
              <div class="col-md-12"> 
                  <form class="form-inline" method="post" id="risk_divisi-form" autocomplete="off">
                      <div class="form-group">
                          <label for="filterFormBy" class="smaller"><font color="#000">Tampil Berdasarkan : </font> </label>
                  ...
                  <table class="table table-condensed table-bordered table-hover" style="color: #000" id="datatable_ajax">
                    <thead>
                      <tr role="row" class="heading">
                        ...
                        <th><center>Dampak Level</center></th>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                ...
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/direksicfo_risk.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px; padding-top: 10px;">
                ...
                <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>RISIKO IIGF - berdasarkan Status Risiko</b></div>
                 <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>Semua Divisi</b></center></span></div>
                 <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
					<object align="center" frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/indexstcfo.php" style="border: 0px solid;" width="100%" height="290"></object>
                </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-12" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px">
              <div style="background-color:#A9A9A9; border: 7px #999999 solid;"> <p style="color:white;  font-size: 16px; margin: 5px;" align="center"><b>Indikator Key Risk (KRI) - berdasarkan Status KRI</b></p></div>
             <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
				<object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicfo/indexcfo_kri_tab4.php"></object>
             </div>
          </div>
      </div>
    </div>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                <div style="background-color:#f2f2f2;box-shadow: 0px 5px 15px 10px #595959;">
                <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>KRI - berdasarkan KRI Warning</b></div>
                <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>Semua Divisi</b></center></span></div>
                <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
                    <object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/indexkricfo.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
...
<div class="tab-pane" id="tab_action_plan_exec">
    <div class="row">
      <div class="col-md-12" style="margin-top: 20px; margin-bottom: 40px;">
          <div class="col-md-12" style="background-color:#f2f2f2; box-shadow: 0px 5px 15px 10px #595959; padding: 0px">
              <div style="background-color:#A9A9A9; border: 7px #999999 solid;"> <p style="color:white;  font-size: 16px; margin: 5px;" align="center"><b>Pelaksanaan Action Plan - berdasarkan Status</b></p></div>
              <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
					<object width="100%" height="250" scrolling="no" frameborder="no" data="<?=$site_url?>1/Chart_PII_beforebuildin/direksicfo/indexcfo_apex_tab3.php"></object>
              </div>
          </div>
      </div>
    </div>
      ...
      <div class="col-md-5">    
          ...
          <div class="row">
              <div class="col-xs-12" style="padding-right:15px; padding-left: 0px;">
                <div style="background-color:#f2f2f2;box-shadow: 0px 5px 15px 10px #595959;">
                <div style="background-color:#A9A9A9; border: 5px #999999 solid;"> <p style="color:white;  font-size: 16px; margin-left: 20px; margin-top: 5px;" align="left"><b>Pelaksanaan Action Plan - berdasarkan Pelaksanaan</b></div>
                <div style="background-color:#f2f2f2;"> <span style="font-size: 16px"><center><b>Semua Divisi</b></center></span></div>
                 <div style="background:url('https://68.media.tumblr.com/695ce9a82c8974ccbbfc7cad40020c62/tumblr_o9c9rnRZNY1qbmm1co1_500.gif') no-repeat center; background-size: 55px;">
					<object frameborder="no" name="frame1" scrolling="no" data="<?=$site_url?>1/pii_pie2/direksiapex_cfo.php" width="100%" height="290"></object>
                </div>
                </div>
              </div>
          </div>
