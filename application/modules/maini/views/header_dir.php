    		...
    		<div class="top-menu">
    			<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-language">
						<a href="<?=$indonya?>" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" src="assets/global/img/flags/id.png">
						<span class="langname">
						<font size="2,5"><b>Indonesia</b></font></span>
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li>
								...
								<a href="<?=$engnya?>">
								<img alt="" src="assets/global/img/flags/gb.png"><font size="2,5"><b>Inggris</b></font></a>
    				...
    				<li class="dropdown dropdown-user">
    					...
    					<ul class="dropdown-menu dropdown-menu-default" style="width: inherit; min-width: 195px;">
                            ...
                            <li>
                                ...
                                <a target="_self" href="<?=$site_url."/maini/mainrac/switchTo/coo"?>">
                           ...
                           <?php }?>
                            ...
                            <li>
                                ...
                                <a target="_self" href="<?=$site_url."/maini/mainrac/switchTo/ceo"?>">
    				...
    				<li class="dropdown dropdown-quick-sidebar-toggler">
    					...
    					<i class="icon-logout"></i> <span style="color: white;"><font size="2,5"><b>Keluar</b></font></span>
    					</a>
    				</li>
