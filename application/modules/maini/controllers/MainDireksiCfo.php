...
class MainDireksiCfo extends APP_Controlleri {
	
	public function index()
	{
		$data = $this->loadDefaultAppConfig();
		$data['indonya'] = base_url('index.php/maini/MainDireksiCfo');
		$data['engnya'] = base_url('index.php/main/MainDireksiCfo');			
		$data['sidebarMenu'] = $this->getSidebarMenuStructure('main/MainDireksiCfo');
		...
		//----
		//actiopn plan
		$data['AP_total_prior_CFO'] = $this->riskdireksi->AP_total_prior_CFO();
		$data['AP_total_cur_CFO'] = $this->riskdireksi->AP_total_cur_CFO();

		$data['AP_ongoing_prior_CFO'] = $this->riskdireksi->AP_ongoing_prior_CFO();
		$data['AP_extend_prior_CFO'] = $this->riskdireksi->AP_extend_prior_CFO();
		$data['AP_complete_prior_CFO'] = $this->riskdireksi->AP_complete_prior_CFO();


		$data['AP_ongoing_cur_CFO'] = $this->riskdireksi->AP_ongoing_cur_CFO();
		$data['AP_extend_cur_CFO'] = $this->riskdireksi->AP_extend_cur_CFO();
		$data['AP_complete_cur_CFO'] = $this->riskdireksi->AP_complete_cur_CFO();

		//kri
		$data['AP_kri_prior_CFO'] = $this->riskdireksi->AP_kri_prior_CFO();
		$data['AP_kri_curent_CFO'] = $this->riskdireksi->AP_kri_curent_CFO();

		$data['AP_kri_green_prior_CFO'] = $this->riskdireksi->AP_kri_green_prior_CFO();
		$data['AP_kri_yellow_prior_CFO'] = $this->riskdireksi->AP_kri_yellow_prior_CFO();
		$data['AP_kri_red_prior_CFO'] = $this->riskdireksi->AP_kri_red_prior_CFO();


		$data['AP_kri_red_cur_CFO'] = $this->riskdireksi->AP_kri_red_cur_CFO();
		$data['AP_kri_yellow_cur_CFO'] = $this->riskdireksi->AP_kri_yellow_cur_CFO();
		$data['AP_kri_green_cur_CFO'] = $this->riskdireksi->AP_kri_green_cur_CFO();
...
public function getmyDirectorate()
	...
	public function getActionPlanExec() {
		...
		$data = $this->riskdireksi->getDataMode('cfoActionPlanExec', $defFilter, $page, $row, $order_by, $order, $filter_by, $filter_value, $filter_divisi);
	...
	public function getKri() {
		...
		$data = $this->riskdireksi->getDataMode('cfoKri', $defFilter, $page, $row, $order_by, $order, $filter_by, $filter_value, $filter_divisi);
