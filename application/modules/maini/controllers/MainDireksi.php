...
class MainDireksi extends APP_Controlleri {
	
	public function index()
	{
	$data = $this->loadDefaultAppConfig();
		$data['indonya'] = base_url('index.php/maini/MainDireksi');
		$data['engnya'] = base_url('index.php/main/MainDireksi');			
		$data['sidebarMenu'] = $this->getSidebarMenuStructure('main/MainDireksi');
		...
		<script src="assets/scripts/dashboard/main_direksi_ceo.js"></script>
		...
		$data['listDivision'] = $this->riskdireksi->getDivision_ceo();
		
		$data['sumAllRisk'] = $this->riskdireksi->sumAllRisk_ceo();
		$data['sumAllRisk_prior'] = $this->riskdireksi->sumAllRisk_prior_ceo();
	
		
		$data['sumHighRisk'] = $this->riskdireksi->sumHighRisk_ceo();
		$data['sumModerateRisk'] = $this->riskdireksi->sumModerateRisk_ceo();
		$data['sumLowRisk'] = $this->riskdireksi->sumLowRisk_ceo();
		$data['sumHighRisk_prior'] = $this->riskdireksi->sumHighRisk_prior_ceo();
		$data['sumModerateRisk_prior'] = $this->riskdireksi->sumModerateRisk_prior_ceo();
		$data['sumLowRisk_prior'] = $this->riskdireksi->sumLowRisk_prior_ceo();
		
		//top five risk
		$data['tabTopFiveRisk']=$this->riskdireksi->tabTopFiveRisk();
		//----
		//actiopn plan
		$data['AP_total_prior_CEO'] = $this->riskdireksi->AP_total_prior_CEO();
		$data['AP_total_cur_CEO'] = $this->riskdireksi->AP_total_cur_CEO();

		$data['AP_ongoing_prior_CEO'] = $this->riskdireksi->AP_ongoing_prior_CEO();
		$data['AP_extend_prior_CEO'] = $this->riskdireksi->AP_extend_prior_CEO();
		$data['AP_complete_prior_CEO'] = $this->riskdireksi->AP_complete_prior_CEO();


		$data['AP_ongoing_cur_CEO'] = $this->riskdireksi->AP_ongoing_cur_CEO();
		$data['AP_extend_cur_CEO'] = $this->riskdireksi->AP_extend_cur_CEO();
		$data['AP_complete_cur_CEO'] = $this->riskdireksi->AP_complete_cur_CEO();

		//kri
		$data['AP_kri_prior_CEO'] = $this->riskdireksi->AP_kri_prior_CEO();
		$data['AP_kri_curent_CEO'] = $this->riskdireksi->AP_kri_curent_CEO();

		$data['AP_kri_green_prior_CEO'] = $this->riskdireksi->AP_kri_green_prior_CEO();
		$data['AP_kri_yellow_prior_CEO'] = $this->riskdireksi->AP_kri_yellow_prior_CEO();
		$data['AP_kri_red_prior_CEO'] = $this->riskdireksi->AP_kri_red_prior_CEO();


		$data['AP_kri_red_cur_CEO'] = $this->riskdireksi->AP_kri_red_cur_CEO();
		$data['AP_kri_yellow_cur_CEO'] = $this->riskdireksi->AP_kri_yellow_cur_CEO();
		$data['AP_kri_green_cur_CEO'] = $this->riskdireksi->AP_kri_green_cur_CEO();
...
public function getriskregisterdireksi()
	{
		...
		$data['cekChangeRequest'] = $this->riskdireksi->cekChangeRequest();
		$data['cekrisklist'] = $this->riskdireksi->cekRiskList();
		$data['cekhigh'] = $this->riskdireksi->cekHigh();
		$data['treatmentlist'] = $this->riskdireksi->treatmentlist();
		$data['cekplan'] = $this->riskdireksi->cekPlanRac();
		$data['cekplanExec'] = $this->riskdireksi->cekPlanExecRac();
		$data['cekkrirac'] = $this->riskdireksi->cekKriRac();
		//top five risk
		$data['tabTopFiveRisk']=$this->riskdireksi->tabTopFiveRisk();
		//----
	...
	public function getAllRisk() {
		...
		$data = $this->riskdireksi->getAllRisk_ceo($page, $row, $order_by, $order, $filter_by, $filter_value, $filter_divisi);
	...
	public function getActionPlanExec() {
		...
		$data = $this->riskdireksi->getDataMode('ceoActionPlanExec', $defFilter, $page, $row, $order_by, $order, $filter_by, $filter_value, $filter_divisi);
	...
	public function getKri() {
		...
		$data = $this->riskdireksi->getDataMode('ceoKri', $defFilter, $page, $row, $order_by, $order, $filter_by, $filter_value, $filter_divisi);
