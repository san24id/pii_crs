			...
			<div class="form-body">
				...
				<div class="form-group">	
					...
					<div class="col-md-2">
						...
						<input type="hidden" class="form-control input-sm input-readview" readonly="true" id="select-treshold-type-1" name="treshold_type">
						<input type="hidden" class="form-control input-sm input-readview" readonly="true" id="select-treshold-type" name="treshold_type">
						<input type="hidden" class="form-control input-sm input-readview" readonly="true" id="select-treshold-type2" name="treshold_type">
						<input type="text" class="form-control input-sm input-readview" readonly="true" name="treshold_name">
