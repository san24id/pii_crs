...
ELSE 0 
END) as 'status'
from t_risk_action_plan JOIN t_action_plan_change on t_risk_action_plan.ap_code = t_action_plan_change.ap_code
	...
	<div class="col-md-12">
			<div class="portlet box blue">
				...
				<div class="portlet-body form">
					...
					<input type="hidden" id="action_id" value="<?=$action_plan['change_data']['ap_code']?>" name="id" placeholder="">
					<input type="hidden" id="action_periode" value="<?=$action_plan['change_data']['periode_id']?>" name="action_periode" placeholder="">
					<input type="hidden" value="<?=$action_plan['risk_id']?>" name="risk_id" placeholder="">
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<textarea name="action_plan" class="form-control input-sm" rows="3"><?=$action_plan['change_data']['action_plan']?></textarea>
								</div>
							</div>
							<div class="form-group">
