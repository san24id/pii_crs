	...
	<div class="page-content">
		...
		<div class="col-md-12">
			...
			<div class="form-actions right">
				<?php if($this->session->credential['main_role_id'] == 2){ ?>
					<button type="button" class="btn yellow" id="kri-button-cancel" onclick="javascript: location.href=site_url+'/main/mainrac/priorkri';"><i class="fa fa-times"></i> Back</button>
				<?php }else{ ?>
					<button type="button" class="btn yellow" id="kri-button-cancel" onclick="javascript: location.href=site_url+'/main/mainpic/priorkri';"><i class="fa fa-times"></i> Back</button>
				<?php } ?>
			</div>
			</form>
			</div>
