...
<div class="page-content-wrapper">
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		Change Request Action Plan Execution Prior
		</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="javascript:;">Action Plan Execution Prior</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body form">
					<form role="form" id="input-form" class="form-horizontal">
						<input type="hidden" id="action-plan-id" value="<?=$action_plan['change_id']?>" name="action_id" placeholder="">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
						<input type="text" class="form-control input-sm input-readview" readonly="true" value="<?=$action_plan['p_execution_status']?>" placeholder="">
						</div>
					</div>
					<?php 
						$h1 = $h2 = '';
						$h3 = "";
						if ($action_plan['p_execution_status'] == 'COMPLETE') { 
							$h2 = 'style="display: none"';
						}
						else if ($action_plan['p_execution_status'] == 'ONGOING') { 
							$h2 = 'style="display: none"';
					...
					<div class="form-group" <?=$h1?>>
						...
						<div class="col-md-9">
						<textarea class="form-control input-sm input-readview" readonly="true" rows="3"  placeholder=""><?=$action_plan['p_execution_explain']?></textarea>
						</div>
					</div>
					...
					<div class="form-group" <?=$h3?>>
						...
						<div class="col-md-9">
						<textarea class="form-control input-sm input-readview" readonly="true" rows="3"  placeholder=""><?=$action_plan['p_execution_evidence']?></textarea>
						</div>
					</div>
					<div class="form-group" <?=$h2?>>
						<label class="col-md-2 control-label smaller cl-compact">Reason</label>
						<div class="col-md-9">
						<textarea class="form-control input-sm input-readview" readonly="true" rows="3"  placeholder=""><?=$action_plan['p_execution_reason']?></textarea>
						</div>
					</div>
					<div class="form-group" <?=$h2?>>
						<label class="col-md-2 control-label smaller cl-compact">Revised Date</label>
						<div class="col-md-9">
							<input type="text" class="form-control input-sm input-readview" readonly value="<?=$action_plan['p_revised_date_v']?>">
						</div>
					</div>			
							</div>
				...
				<div class="portlet-body form">
					...
					<div class="form-group" id="fgroup-date" <?=$g2?>>
						...
						<div class="form-actions right">
							<button id="approve-apexprior-form-submit" type="button" class="btn blue"><i class="fa fa-check-circle"></i> Approve</button>
