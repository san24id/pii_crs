		...
		<div class="col-md-12">
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
					<span class="man"><input checked data-toggle="toggle" type="checkbox" data-size="small" data-width="140" data-onstyle="danger" data-on = "Mandatory" data-off = "Non Mandatory" id="cek-mitigation"></span>
			...
			<div class="form-actions right">
				<button id="kri-button-submit" type="button" class="btn blue"><i class="fa fa-check-circle"></i> Activate</button>
		...
		<div>
			<table id="kri_library_table" class="table table-condensed table-bordered table-hover">
				...
				<tr role="row" class="heading">
					...
					<th>Mandatory/<br />Non Madatory?</th>
				</tr>
				</thead>
				<tbody></tbody>
			</table>
