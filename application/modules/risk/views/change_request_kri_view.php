	...
	<div class="page-content">
		...
		<div class="col-md-12">
			...
			<div class="form-body">
				...
				<div class="col-md-6">		
				<textarea class="form-control input-sm input-readview"  data-container="body" data-placement="bottom" rows="3" name="support" id="support" readonly="true"><?=$kri['supporting_evidence']?></textarea>
				</div>
				</div>  
			</div>
			<?php if (isset($verify) && $verify) { ?>
