...
?>
						<div class="form-actions">
							<button class="btn red" type="button" id="risk-button-delete"><i class="fa  fa-trash-o"></i> Delete</button>
							...
							<?php }else{ ?>
								<button id="primary-risk-button-submit" type="button" class="btn blue" style="float: right;"><i class="fa fa-check-circle"></i> Verify</button>
							<?php } ?>
						</div>
					</form>
				</div>	
		...
		<input type="hidden" value="<?php echo $suggested; ?>" id="sgrt" />	
							<div class="row">
								...
								<div class="col-md-6 clearfix" id="btnaction">
									<a href="#form-data" data-toggle="modal" class="btn default green pull-right btn-sm" id="button-form-data-open-ap">
									<i class="fa fa-plus"></i>
									<span class="hidden-480">
