...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		$this->load->database();
		$sql = "select distinct b.due_date from m_action_plan a, t_risk c, t_risk_action_plan b where c.risk_id = b.risk_id and c.periode_id = (select max(periode_id) from m_periode) and a.action_plan = b.action_plan and a.division = b.division and a.id ='$id_ap' and b.action_plan_status < 4";
				...
				<div class="portlet-body form">
					...
					<input type="hidden" id="form-action-id" name="action_id" value="<?=$action_plan['id_ap']?>" />
						...
						<div class="form-body">
							...
							<div class="col-md-12">	
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input type="text" class="form-control input-sm input-readview" name="division" value="<?=$action_plan['division_v']?>" readonly="true">
									</div>
								</div>
						...
						<div class="form-actions right">
							<?php if($_GET['kat']=='ap'){?>
									<a href="<?php echo site_url('main/mainpic/#tab_action_plan'); ?>"><button type="button" class="btn yellow"><i class="fa fa-times"></i> Back</button></a>
								<?php }else if($_GET['kat']=='ac'){?>
									<a href="<?php echo site_url('main/mainpic/#tab_action_exec'); ?>"><button type="button" class="btn yellow"><i class="fa fa-times"></i> Back</button></a>
								<?php }else{?>
