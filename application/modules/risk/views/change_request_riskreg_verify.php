				...
				<div class="portlet-body form">
					...
					<input type="hidden" name="id" value="" />
						...
						<?php if ($change_type != 'Delete Risk') { ?>
							...
							<button id="primary-register_form-button-submit" type="button" class="btn blue"><i class="fa fa-check-circle"></i> Approve</button>
						<?php } ?>
						</div>
				...
				<div class="portlet-body form">
					<form id="input-form" role="form" class="form-horizontal">
						...
						<div class="form-body">
							...
							<?php if ($change_type == 'Risk Form' || $change_type == 'Risk Owner Form' || $change_type == 'Delete Risk' || $change_type == 'Risk Form Library') { ?>
							<div class="form-group">
								<label class="col-md-3 control-label smaller cl-compact">Risk Event</label>
								<div class="col-md-9">
...
<!-- Change Info -->
<div id="form-info-modal" class="modal fade" tabindex="-1" data-width="1025" data-backdrop="static" data-keyboard="false">
						...
						<div class="form-body">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-md-3 control-label smaller cl-compact" >Impact Level</label>
									<div class="col-md-9">
									<input type="text" class="form-control input-sm input-readview" readonly="true" value="<?=$risk['impact_level_v']?>" placeholder="">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label smaller cl-compact" >Likelihood</label>
									<div class="col-md-9">
										<input type="text" class="form-control input-sm input-readview" readonly="true" value="<?=$risk['likelihood_v']?>" placeholder="">
									</div>
								</div>
								<div class="form-group">
									...
									<label class="col-md-3 control-label smaller cl-compact" >Risk Level</label>
									<div class="col-md-9">
									<input type="text" class="form-control input-sm input-readview" readonly="true" value="<?=$risk['risk_level_v']?>" placeholder="">
									</div>
								</div>
							</div>
							</div>
