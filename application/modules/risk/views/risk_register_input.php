	...
	<div class="page-content">
		...
		<input type="hidden" value="<?php echo $suggested2; ?>" id="sgrt2">
						...
						<?php if(isset($modifyRisk)) { 
							...
							<button type="button" class="btn yellow" id="risk-button-cancel_r"><i class="fa fa-times"></i> Cancel/ Back</button>
						<?php }else{?>
						...
						<?php }} else { ?>
							...
							<?php } else { ?>
								...
								<button type="button" class="btn yellow" id="risk-button-cancel_period"><i class="fa fa-times"></i> Cancel/ Back</button>
							<?php } ?>
						<?php } ?>
						</div>
