           ...
           <!--  this form for no AJAX  -->
                ...
                <form target="_self" action="<?=$site_url?>/login/authenticate" method="post" id="input-form" role="form" class="login-form">
                   ...
                   <?php 
                    ...
                    ?>
                            <div class="alert alert-danger">
                            <span id="">You cannot log in iRisk right now, please contact RAC for further information</span>
                            </div>
                    <?php
                            }
                    ?>
                 <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">Username</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" autofocus required oninvalid="this.setCustomValidity('please input username')" oninput="setCustomValidity('')" />
                </div>

                  <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" autofocus required oninvalid="this.setCustomValidity('please input password')" oninput="setCustomValidity('')"   />
                </div>     
