			...
			<div class="page-toolbar">
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu pull-right" role="menu">
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/library/risk_aggregate_pdf/$id_period");?>">PDF</a>
						</li>
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/library/risk_aggregate_excel/$id_period");?>">Excel</a>
						</li>
	...
	$mxperiod =  $key['periode_id'];
		...
		<div class="portlet">
			...
			<?php if($mxperiod == $id_period){ ?>
				<div class="actions">
					<a href="<?php echo site_url(); ?>/risk/RiskRegister/RiskAggregateInput/<?php echo $id_period; ?>" class="btn default green-stripe">
					<i class="fa fa-plus font-green"></i>
					<span class="hidden-480">
					Entry New From Library</span>
					</a>
				</div>
			<?php } ?>
			</div>
