    		...
    		<div class="top-menu">
    			<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-language">
						...
						<span class="langname">
						<font size="2,5"><b>English</b></font></span>
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li>
								...
								<a href="<?=$indonya?>">
								<img alt="" src="assets/global/img/flags/id.png"><font size="2,5"><b> Indonesian</b> </font></a>
    				...
    				<li class="dropdown dropdown-quick-sidebar-toggler">
    					<a href="<?=$site_url."/login/Logout"?>" target="_self" class="dropdown-toggle">
    					<i class="icon-logout"></i> <span style="color: white;"><font size="2,5"><b>Sign Out</b></font></span>
    					</a>
    				</li>
