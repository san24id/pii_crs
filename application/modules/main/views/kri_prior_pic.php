...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		Key Risk Indicator Periode : <?php 
			$this->load->database();
			$sql = "SELECT * FROM  m_periode WHERE periode_id IN ((SELECT MAX(periode_id) FROM m_periode)-2)";
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="javascript:;">Prior Period KRI</a>
				</li>
			</ul>
			<div class="page-toolbar">
				...
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu pull-right" role="menu">
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/main/getKRIUserPrior_pdf?role=$role&divisi=$divisi&user=$user");?>">PDF</a>
						</li>
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/main/getKRIUserPrior_excel?role=$role&divisi=$divisi&user=$user");?>">Excel</a>
						</li>
