				...
				<div class="portlet-body form">
					<form id="input-form" role="form" class="form-horizontal">
						<div class="form-body">
							...
							<input type="hidden" name="id_event" class="form-control input-sm" value="<?php echo $row_event['id_event']; ?>">	
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" name="nama_proyek" class="form-control input-sm" value="<?php echo $row_event['nama_proyek']; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" name="nilai_proyek" class="form-control input-sm" value="<?php echo $row_event['nilai_proyek']; ?>" placeholder="number only" id="rupiah">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control input-sm popovers"  data-container="body" data-placement="bottom" rows="3" name="kejadian" data-required="1" placeholder="" data-content="" ><?php echo $row_event['kejadian']; ?></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" name="nilai_kerugian" class="form-control input-sm" value="<?php echo $row_event['nilai_kerugian']; ?>"  placeholder="number only" id="rupiah_nilai">
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control input-sm popovers"  data-container="body" data-placement="bottom" rows="3" name="deskripsi" data-required="1" placeholder="" data-content="" ><?php echo $row_event['deskripsi']; ?></textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="">
										<input type="text" class="form-control input-sm" name="periode" value="<?php echo $row_event['periode']; ?>" id = "periode" placeholder="select date" readonly>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control input-sm popovers"  data-container="body" data-placement="bottom" rows="3" name="penyebab" data-required="1" placeholder="" data-content="" ><?php echo $row_event['penyebab']; ?></textarea>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control input-sm popovers"  data-container="body" data-placement="bottom" rows="3" name="lesson_learned" data-required="1" placeholder="" data-content="" ><?php echo $row_event['lesson']; ?></textarea>
									</div>
								</div>
						...
						<div class="form-actions right">
								<button id="risk-button-update" type="button" class="btn blue"><i class="fa fa-circle-o"></i> Save</button>
