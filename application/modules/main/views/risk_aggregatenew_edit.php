	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="<?=$site_url?>/main/mainrac/aggregatrisk/<?=$pid?>">Aggregate Risk</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
						...
						<div class="form-body">
							...
							<div class="col-md-6">	
								...
								<div class="form-group">
										...
										<input type="hidden" name="risk_idag"/>
		...
		<input type="hidden" value="<?php echo $suggested2; ?>" id="sgrt2">
						...
						<?php }else{?>
							...
							<button id="risk-button-transfer" type="button" class="btn blue"><i class="fa fa-arrows-h"></i></i>Transfer</button>
							<a href="<?php echo site_url() ?>/main/mainrac/aggregatrisknew/<?php echo $pid; ?>"><button type="button" class="btn yellow"><i class="fa fa-times"></i> Cancel/ Back</button></a>
