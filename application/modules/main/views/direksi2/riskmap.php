...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
  ...
  <table class="responsive table table-striped table-bordered table-hover" width="100%" border="1" cellspacing="1" cellpadding="1" style="font-size: 10px;"> 
        ...
        <tr>
        <th><h3 align="center"><b> RISK IMPACT</b></h3></th>
        <td height="20">
        <div align="center">
          <br><br><strong>VERY LOW</strong><br>
        </div></td>
    <td>
    <div align="center"><br><br><strong>LOW</strong></div></td>
    <td>
    <div align="center"><br><br><strong>MEDIUM</strong></div></td>
    <td>
    <div align="center"><br><br><strong>HIGH</strong></div></td>
    <td>
    <div align="center"><br><br><strong>VERY HIGH</strong></div></td>
  </tr>
