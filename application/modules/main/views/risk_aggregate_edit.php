	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="<?=$site_url?>/main/mainrac/aggregatrisk/<?=$pid?>">Aggregate Risk Library</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
						...
						<div class="form-body">
							...
							<div class="col-md-6">	
								...
								<div class="form-group">
									...
									<input type="hidden" name="risk_idag" value=""/>
								...
								<div class="form-group">
									<input type="hidden" name="risk_library_id" value=""/>
									<label class="col-md-3 control-label smaller cl-compact">Risk ID <span class="required">* </span></label>
									<div class="col-md-9">
										<div class="input-group">
											<input type="text" style="width: 100%; height: 28px; padding-left: 10px;" readonly="true" name="risk_library_code" placeholder="Risk from library">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<select class="form-control input-sm" id="sel_risk_category" disabled="disabled"></select>
									</div>
									<input type="hidden" name="risk_category">
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label smaller cl-compact" >Risk Sub Category<span class="required">* </span></label>
									<div class="col-md-9">
									<select class="form-control input-sm" name="" id="sel_risk_sub_category" disabled="disabled">
									</select>
									</div>
									<input type="hidden" name="risk_sub_category">
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9">
									<select class="form-control input-sm" name="" id="sel_risk_2nd_sub_category" disabled="disabled">
									</select>
									</div>
									<input type="hidden" name="risk_2nd_sub_category">
								</div>
								<div class="form-group">
		...
		<input type="hidden" value="<?php echo $suggested2; ?>" id="sgrt2">
						...
						<?php if(isset($modifyRisk)) { 
								if($_GET['s'] == 'register'){
							?>
							<button id="risk-button-modify_r" type="button" class="btn blue"><i class="fa fa-circle-o"></i> Save</button>
							<button id="risk-button-delete_r" type="button" class="btn red"><i class="fa  fa-trash-o"></i> Delete</button>
							<a href="<?php echo site_url() ?>/main/mainrac/aggregatrisk/<?php echo $pid; ?>"><button type="button" class="btn yellow"><i class="fa fa-times"></i> Cancel/ Back</button></a>
						<?php }else{?>
						...
						<?php }} else { ?>
								...
								<button id="risk-button-draft_t" type="button" class="btn blue"><i class="fa fa-circle-o"></i> Save</button>
								<button id="risk-button-delete_t" type="button" class="btn red"><i class="fa  fa-trash-o"></i> Delete</button>
								<a href="<?php echo site_url() ?>/main/mainrac/aggregatrisk/<?php echo $pid; ?>"><button type="button" class="btn yellow"><i class="fa fa-times"></i> Cancel/ Back</button></a>
						<?php } ?>
						</div>
