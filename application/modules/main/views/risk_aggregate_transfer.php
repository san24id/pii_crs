...
<div class="page-content-wrapper">
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		Risk Form Transfer Aggregate To Library
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="<?=$site_url?>/main/mainrac/aggregatrisk">Risk Aggregate Library</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
					...
					<form id="primary-input-form" role="form" class="form-horizontal">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								<textarea class="form-control input-sm input-readview input-readview" readonly="readonly"  rows="3" name="risk_event" placeholder=""></textarea>
								</div>
							</div>
							<div class="form-group">
	...
	<?php 
		...
		?>
						...
						<div class="form-actions">
							...
							<a href="<?=site_url(); ?>/main/mainrac/aggregatrisk/<?=$pid?>"><button class="btn yellow" type="button"></i> Back</button></a>
							<input type="hidden" name="submit_mode" value="verifyRisk" />
							<button id="primary-risk-button-verify" type="button" class="btn blue" style="float: right;"><i class="fa fa-arrows-h"></i></i>Transfer</button>
						</div>
					</form>
				</div>
			</div>
