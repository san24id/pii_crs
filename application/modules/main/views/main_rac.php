...
<?php if($query == true){
				$i = "<b>You have undermaintenance risk, please check menu transaction undermaintenance</b>";
				echo '<p style="border: solid 1px #e6e6e6; width: 40%; padding:3px;"><i class="fa fa-info-circle font-red" style="font-size:15px;"> '.$i.'</i></p>';
			} ?>
    ...
    $('[data-toggle="tab"]').tooltip();   
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab_risk_list">
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_risk_list" >
						...
						<td style="padding-bottom: 5px; padding-right: 6px;"><select class="form-control input-medium input-sm" id="tab_risk_list-filterBy">
								...
								<option value="risk_level_after_mitigation" data-FilterRiskList = "Risk Level After Mitigation">Risk Level After Mitigation</option>
								<option value="risk_impact_level_after_mitigation" data-FilterRiskList = "Impact Level After Mitigation">Impact Level After Mitigation</option>
								<option value="risk_likelihood_key_after_mitigation" data-FilterRiskList = "Likelihood After Mitigation">Likelihood After Mitigation</option>
					...
					<tr>
					<td><label for="filterFormBy" class="smaller">Total all records</label></td>
						<td><label>:</label></td>
						<td><label><?=$sumAllRisk?></label></td>
				   </tr>
					</form>
				   </table>
				...
				<div class="tab-pane" id="tab_risk_register_list">	
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_risk_register_list">
						...
						<td style="padding-bottom: 5px; padding-right: 6px;">
							<select class="form-control input-medium input-sm" id="tab_risk_register_list-filterBy">
								...
								<option value="risk_status" data-FilterRiskList = "Status">Status</option>
								<option value="display_name" data-FilterRiskList = "User Name">User Name</option>
								<option value="division_name" data-FilterRiskList = "Division">Division</option>
							</select>
						</td>
					
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_s_level-register">
							<select class="form-control input-medium input-sm" id="s_level-register">
								<option value="-">All Status</option>
								<option value="submitted" data-status = "Submitted to RAC">Submitted to RAC</option>
								<option value="treatment" data-status = "Verified by RAC">Verified by RAC</option>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_divisi-register">
							<select class="form-control input-sm" id="l_divisi-register">
								<option value="-">All</option>
								<?php foreach ($division_list as $key) {?>
									<option value="<?php echo $key['ref_value']; ?>" data-division = "<?php echo $key['ref_value'];?>" data-division2 = "<?php  echo $key['ref_value'];?>"><?php echo $key['ref_value'];?></option>
								<?php }?>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_hood">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id=register_search>
							<input type="text" class="form-control input-sm" placeholder="Search" id="tab_risk_register_list-filterValue">
							<input type="text" class="form-control input-sm" placeholder="Search" id="s_risklist_reg">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rg_1">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rg_2">
						</td>
						<td style="padding-bottom: 5px;"><button type="button" class="btn blue btn-sm" id="tab_risk_register_list-filterButton">Search</button></td>
					</tr>
					</form>
					...
					<td><label>:</label></td>
					<td style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rg_3" value="<?php if(isset($_SESSION['filter_rg_1'])){echo $_SESSION['filter_rg_1']; } ?>"></td>
					<td  style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rg_4" value="<?php if(isset($_SESSION['filter_rg_2'])){echo $_SESSION['filter_rg_2']; } ?>">
					</td>
				    </tr>
					<tr>
					<td><label for="filterFormBy" class="smaller">Total all records</label></td>
						<td><label>:</label></td>
						<td><label><?=$sumAllRiskReg?></label></td>
				   </tr>
					</form>
				   </table>
				...
				<div class="tab-pane" id="tab_treatment_list">
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_treatment_list">
						...
						<td style="padding-bottom: 5px; padding-right: 6px;">
							<select class="form-control input-medium input-sm" id="tab_treatment_list-filterBy">
								...
								<option value="risk_event" data-FilterRiskList= "Risk Event">Risk Event</option>
								<option value="risk_owner" data-FilterRiskList = "Risk Owner">Risk Owner</option>
								<option value="suggested_risk_treatment" data-FilterRiskList = "Risk Treatment">Risk Treatment</option>
							</select>
						</td>
					
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_s_level-treatment">
							<select class="form-control input-medium input-sm" id="s_level-treatment">
								<option value="-">All Status</option>
								<option value="draft" data-treatlevel ="Draft">Draft</option>
								<option value="submitted" data-treatlevel= "Submitted to RAC">Submitted to RAC</option>
								<option value="treatment" data-treatlevel = "Verified by RAC">Verified by RAC</option>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_divisi-treatment">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_risk-treatment">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id=treatment_search>
							<input type="hidden" class="form-control input-sm" placeholder="Search" id="tab_treatment_list-filterValue">
							<input type="text" class="form-control input-sm" placeholder="Search" id="s_risklist_treat">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rt_1">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rt_2">
						</td>
						<td style="padding-bottom: 5px;"><button type="button" class="btn blue btn-sm" id="tab_treatment_list-filterButton">Search</button></td>
					</tr>
					</form>
					...
					<td><label>:</label></td>
					<td style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rt_3" value="<?php if(isset($_SESSION['filter_rt_1'])){echo $_SESSION['filter_rt_1']; } ?>"></td>
					<td  style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rt_4" value="<?php if(isset($_SESSION['filter_rt_2'])){echo $_SESSION['filter_rt_2']; } ?>">
					...
					<td><label for="filterFormBy" class="smaller">Total all records</label></td>
						<td><label>:</label></td>
						<td><label><?=$sumAllTreatment?></label></td>
				   </tr>
					</form>
				   </table>
					...
					<?php
							foreach ($setting_dasborad as $key) {
								if($key['type'] == 3 && $key['status'] == 0){
									$setting_riskown = '';
									$owner = '<button type="button" class="btn btn-sm btn-warning" id="hide_risk_owner">Hide</button>';
								}else if($key['type'] == 3 && $key['status'] == 1){
									$setting_riskown = 'style="display:none;"';
									$owner = '<button type="button" class="btn btn-sm btn-primary" id="show_risk_owner">Show</button>';
								}
							}
					?>
				...
				<div class="tab-pane" id="tab_action_plan_list">
				 <table>
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_action_plan_list">
						...
						<td style="padding-bottom: 5px; padding-right: 6px;">
							<select class="form-control input-medium input-sm" id="tab_action_plan_list-filterBy">
								<option value="choose">Choose / Show All</option>
								<option value="action_plan_status" data-filterAp = "Status">Status</option>
								<option value="ap_code" data-filterAp = "Ap.ID">AP.ID</option>
								<option value="action_plan" data-filterAp = "Action Plan">Action Plan</option>
								<option value="due_date" data-filterAp = "Due Date">Due Date</option>
								<option value="division" data-filterAp = "Action Plan Owner">Action Plan Owner</option>
								<option value="risk_code" data-filterAp = "Risk ID">Risk ID</option>
								<option value="risk_owner" data-filterAP = "Risk Owner">Risk Owner</option>
							</select>
						</td>
					
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_s_level-action">
							<select class="form-control input-medium input-sm" id="s_level-action">
								<option value="-">All Status</option>
								<option value="draft" data-levelAp = "Draft">Draft</option>
								<option value="submitted" data-levelAP = "Submitted to RAC">Submitted to RAC</option>
								<option value="treatment" data-levelAp = "Verified by RAC">Verified by RAC</option>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_divisi-action">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_owner-action">
							<select class="form-control input-sm" id="l_owner-action">
								<option value="-">All</option>
								<?php foreach ($division_list as $key) {?>
									<option value="<?php echo $key['ref_key']; ?>" data-owner = "<?php echo $key['ref_key'];?>" data-owner2 = "<?php echo $key['ref_value'];?>"><?php echo $key['ref_value'];?></option>
								<?php }?>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="ap_id">
							<div class="input-group">
   								 <span class="input-group-addon">AP.</i></span>
   								 <input id="s_action_plan_list2" type="text" class="form-control input-sm">
 							 </div>
 						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id=actionplan_search>
							<input type="hidden" class="form-control input-sm" placeholder="Search" id="tab_action_plan_list-filterValue">
							<input type="text" class="form-control input-sm" placeholder="Search" id="s_action_plan_list">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rap_1">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rap_2">

						</td>
						<td style="padding-bottom: 5px;"><button type="button" class="btn blue btn-sm" id="tab_action_plan_list-filterButton">Search</button></td>
					</tr>
					...
					<td><label>:</label></td>
					<td style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rap_3" value="<?php if(isset($_SESSION['filter_rap_1'])){echo $_SESSION['filter_rap_1']; } ?>"></td>
					<td  style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rap_4" value="<?php if(isset($_SESSION['filter_rap_2'])){echo $_SESSION['filter_rap_2']; } ?>">
				...
				<div class="tab-pane" id="tab_kri_list">
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_kri" >
						...
						<td style="padding-right: 56px;"><label for="filterFormBy" class="smaller">Filter By</label></td>
						<td style="padding-right: 6px;"><label>:</label></td>
						<td style="padding-bottom: 5px; padding-right: 6px;"><select class="form-control input-medium input-sm" id="tab_kri-filterBy">
								<option value="choose">Choose / Show All</option>
								<option value="kri_status" data-KRIfilter="Status">Status</option>
								<option value="key_risk_indicator" data-KrIfilter="KRI">KRI</option>
								<option value="kri_owner" data-KRIfilter="KRI Owner">KRI Owner</option>
								<option value="timing_pelaporan" data-KRIfilter="Time Reporting">Time Reporting</option>
								<option value="risk_code" data-KRIfilter="Risk ID">Risk ID</option>
								<option value="kri_warning" data-KRIfilter="KRI Warning">KRI Warning</option>
							</select>
						</td>
					
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_kri_s">
							<select class="form-control input-medium input-sm" id="k_status">
								<option value="-" data-k_status = "">All</option>
								<option value="save_draft" data-k_status = "Save Draft">Save Draft (KRI still not active)</option>
								<option value="draft" data-k_status = "Draft">Draft (KRI has active and will be submit by Division Head)</option>
								<option value="submitted" data-k_status = "Submitted to RAC">Submitted to RAC</option>
								<option value="verified" data-K_status = "Verified by RAC">Verified by RAC</option>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_kri_w">
							<select class="form-control input-medium input-sm" id="k_warning">
								<option value="-">All</option>
								<option value="GREEN" data-warning="Green">Green</option>
								<option value="YELLOW" data-warning="Yellow">Yellow</option>
								<option value="RED" data-warning="Red">Red</option>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_divisi-kri">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id=kri_search>
							<input type="text" class="form-control input-sm" placeholder="Search" id="s_krilist">
							<input type="hidden" class="form-control input-sm" placeholder="Search" id="tab_kri-filterValue">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rm_1">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rm_2">
						</td>
						<td style="padding-bottom: 5px;"><button type="submit" class="btn blue btn-sm" id="tab_kri-filterButton">Search</button></td>
					</tr>
					</form>
					...
					<td><label>:</label></td>
					<td style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rm_3" value="<?php if(isset($_SESSION['filter_rm_1'])){echo $_SESSION['filter_rm_1']; } ?>"></td>
					<td  style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rm_4" value="<?php if(isset($_SESSION['filter_rm_2'])){echo $_SESSION['filter_rm_2']; } ?>">
				...
				<div class="tab-pane" id="tab_risk_old">
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_old_risk_list" >
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_s_level-prior">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_r_level-prior">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_hood-prior">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_impact_l-prior">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_divisi-prior">
						...
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id=risk_search-prior>
							<input type="hidden" class="form-control input-sm" placeholder="Search" id="tab_old_risk_list-filterValue">
							<input type="text" class="form-control input-sm"  placeholder="Search" id="s_risklist_prior">
						...
						<td style="padding-bottom: 5px;"><button type="submit" class="btn blue btn-sm" id="tab_old_risk_list-filterButton">Search</button></td>
					</tr>
					</form>
					...
					<td><label>:</label></td>
					<td style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rlp_3" value="<?php if(isset($_SESSION['filter_rlp_1'])){echo $_SESSION['filter_rlp_1']; } ?>"></td>
					<td  style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rlp_4" value="<?php if(isset($_SESSION['filter_rlp_2'])){echo $_SESSION['filter_rlp_2']; } ?>">
					...
					<td><label for="filterFormBy" class="smaller">Total all records</label></td>
						<td><label>:</label></td>
						<td><label><?=$sumAllOldRisk?></label></td>
				   </tr>
					</form>
				   </table>
...
****************************************************************************************************************-->
				<div class="tab-pane" id="tab_kri_list_non_mitigation">
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_kri_nonmtg" >
						...
						<td style="padding-bottom: 5px; padding-right: 6px;">
							<select class="form-control input-medium input-sm" id="tab_kri_nonmtg-filterBy">
								<option value="choose">Choose / Show All</option>
								<option value="kri_status" data-KRIfilternon="Status">Status</option>
								<option value="key_risk_indicator" data-KrIfilternon="KRI">KRI</option>
								<option value="kri_owner" data-KRIfilternon="KRI Owner">KRI Owner</option>
								<option value="timing_pelaporan" data-KRIfilternon="Time Reporting">Time Reporting</option>
								<option value="risk_code" data-KRIfilternon="Risk ID">Risk ID</option>
							</select>
						</td>
					
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_kri_s_nonmtg">
							<select class="form-control input-medium input-sm" id="k_status_nonmtg">
								<option value="-" data-k_statusnon = "">All</option>
								<option value="save_draft" data-k_statusnon = "Save Draft">Save Draft (KRI still not active)</option>
								<option value="draft" data-k_statusnon = "Draft">Draft (KRI has active and will be submit by Division Head)</option>
								<option value="submitted" data-k_statusnon = "Submitted to RAC">Submitted to RAC</option>
								<option value="verified" data-K_statusnon = "Verified by RAC">Verified by RAC</option>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id="choose_l_divisi-kri_nonmtg">
							<select class="form-control input-sm" id="l_divisi-kri_nonmtg">
								<option value="-">All</option>
								<?php foreach ($division_list as $key) {?>
									<option value="<?php echo $key['ref_key']; ?>" data-divisionnon = "<?php echo $key['ref_key'];?>" data-division2non = "<?php echo $key['ref_value'];?>"><?php echo $key['ref_value'];?></option>
								<?php }?>
							</select>
						</td>
						<td style="padding-bottom: 5px; padding-right: 6px; display: none;" id=kri_search_nm>
							<input type="text" class="form-control input-sm" placeholder="Search" id="s_krilistnon">
							<input type="hidden" class="form-control input-sm" placeholder="Search" id="tab_kri_nonmtg-filterValue">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rnm_1">
							<input type="hidden" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rnm_2">
						</td>
						<td style="padding-bottom: 5px;"><button type="submit" class="btn blue btn-sm" id="tab_kri_nonmtg-filterButton">Search</button></td>
					</tr>
					</form>
					...
					<td><label>:</label></td>
					<td style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rnm_3" value="<?php if(isset($_SESSION['filter_rnm_1'])){echo $_SESSION['filter_rnm_1']; } ?>"></td>
					<td  style="padding-bottom: 5px; padding-right: 6px;"><input type="text" class="form-control input-sm" placeholder="Search" readonly="readonly" id="rnm_4" value="<?php if(isset($_SESSION['filter_rnm_2'])){echo $_SESSION['filter_rnm_2']; } ?>">
					...
					<td><label for="filterFormBy" class="smaller">Total all records</label></td>
						<td><label>:</label></td>
						<td><label><?=$sumAllKRINon?></label></td>
				   </tr>
					</form>
				   </table>
...
<!-- PIC -->
<div id="modal-pic" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false">
	<div class="modal-header">
	...
	<div class="modal-body">
			...
			<form id="noteform" role="form" class="form-horizontal">
				<div class="form-body">
					<div class="form-group">
	...
	<div class="modal-footer">
		...
		<button id="edit_note" type="button" 
