...
<div class="table-header">
	<center><div class="table-caption"><font = "3"><b> Dashboard Action Plan Execution List Periode : <?php echo $query->periode_name; ?></div>
</div> 
<table class="table table-condensed table-bordered table-hover " id="datatable_ajax" border="1">
	...
	<thead>
		<tr role="row" class="heading">
			...
			<?php if(isset($dataget['risk_code'])):?><th>Risk Code</th><?php endif;?>  
