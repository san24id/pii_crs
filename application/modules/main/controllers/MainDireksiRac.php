...
class MainDireksiRac extends APP_Controller {
...
public function getAllRisk_excel() {
	...
	public function m_division(){
		$data = $this->loadDefaultAppConfig();
		$data['indonya'] = base_url('index.php/main/maindireksiraci/m_division');
		$data['engnya'] = base_url('index.php/main/maindireksirac/m_division');			
		$data['sidebarMenu'] = $this->getSidebarMenuStructure('main/maindireksirac/m_division');
		$data['pageLevelStyles'] = '
		<link rel="stylesheet" type="text/css" href="assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>
		<link href="assets/global/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css" rel="stylesheet" type="text/css"/>
		<link href="assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css" rel="stylesheet" type="text/css"/>
		...
		<script src="assets/global/plugins/bootstrap-modal/js/bootstrap-modalmanager.js" type="text/javascript"></script>
		<script src="assets/global/plugins/bootstrap-modal/js/bootstrap-modal.js" type="text/javascript"></script>
		<script src="assets/scripts/user/manage_division_direksi.js"></script>
		';
		...
		$this->load->view('user/manage_division_direksi', $data);
	...
	public function userMove()
	{
		$session_data = $this->session->credential;
			...
			$res = $this->division->updateMove($_POST['division_id'], $_POST['direk_id'], $_POST['direksi_new'], $par, $session_data['username']);
