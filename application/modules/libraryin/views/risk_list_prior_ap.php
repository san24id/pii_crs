		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				<li>
					...
					<a target="_self" href="javascript:history.back()">Kembali</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a target="_self" href="javascript:;">Daftar Risiko</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
...
$username = $this->session->credential['username'];
	...
	$sql="SELECT DISTINCT b.id, b.action_plan, b.division, e.division_name, c.risk_code, c.risk_id, c.risk_event, c.risk_description, c.risk_cause, c.risk_impact
				...
				JOIN (SELECT risk_code, MAX((periode_id)-1) as periode_id FROM t_risk GROUP BY risk_code) d ON c.risk_code = d.risk_code AND c.periode_id = d.periode_id where b.id = '$id' and c.existing_control_id is null and c.risk_status > 2 and c.switch_flag = 'P' ORDER BY c.risk_code ASC";
...
<div id="modal-library" class="" tabindex="-1" data-width="860" data-keyboard="false">
	<div class="modal-header">
		<h4 class="modal-title">Risiko</h4>
	</div>
		...
		<div>
			<table class="table table-condensed table-bordered table-hover">
				...
				<tr role="row" class="heading">
					...
					<th width="65%">Deskripsi Risiko</th>
				</tr>
				</thead>
				<tbody>
			    <?php 
      			...
      			?>
      			<tr>
      				<td><a href="<?php echo $site_url ?>/maini/viewRisk/<?php echo $row['risk_id'] ?>"> <?php echo $row['risk_code']; ?></a></td>
