	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li class="bread_tab">
					<a id="bread_tab_title" target="_self" href="javascript:;">Taksonomi Sub Kategori Level 2</a>
				</li>
			</ul>
					...
					<form class="form-inline" role="form" style="margin-bottom: 10px;" id="form_tab_taksonomi_list">
						<div class="form-group">
							...
							<select class="form-control input-medium input-sm" id="tab_taksonomi_list-filterBy">
								<option value="cat_name">Nama</option>
								<option value="cat_desc">Deskripsi</option>
							</select>
						</div>
						<div class="form-group">
							<input type="text" class="form-control input-sm" placeholder="Insert Filter Value" id="tab_taksonomi_list-filterValue">
						</div>
						<button type="submit" class="btn blue btn-sm" id="tab_taksonomi_list-filterButton">Cari</button>
					</form>
...
<div id="modal_listrisk" class="modal fade" tabindex="-1" data-width="860" data-keyboard="false">
	<div class="modal-header">
		...
		<h4 class="modal-title">Pustaka Taksonomi Risiko</h4>		 
	</div>
