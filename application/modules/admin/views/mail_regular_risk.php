				...
				<form  action="<?=$site_url?>/admin/reminder/send_mail_risk" method="post" id="input-form" role="form" class="form-horizontal">
					<div class="form-body">
						...
						<div class="form-actions right">
								<button id="input-form-send-register"  name="send_register" class="btn green ladda-button" data-style="expand-right">Save & Send Mail</button>
								<button id="input-form-save-register"  name="save_register" class="btn blue ladda-button" data-style="expand-right">Save</button>
