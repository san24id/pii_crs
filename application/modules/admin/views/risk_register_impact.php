...
<div class="page-content-wrapper">
	...
	$status = $_GET['status'];
		?>
							...
							<button id="risk-impact_edit" type="button" class="btn blue"><i class="fa fa-circle-o"></i> Save</button>
							<button type="button" class="btn yellow" id="risk-impact_cancel"><i class="fa fa-times"></i> Cancel</button>
						</div>
