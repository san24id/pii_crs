...
<div class="page-content-wrapper">
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		Mail Regular Risk Register Exercise
		</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="javascript:;">Reminder regular risk register exercise</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
...
tinymce.init({
		...
		<div class="col-md-12">
			<div class="form">
				<form  action="<?=$site_url?>/admin/reminder/save_mail_execution/<?=$mail['id'];?>" method="post" id="input-form" role="form" class="form-horizontal">
					<div class="form-body">

					  <div class="form-group">
									<label class="col-md-2 control-label">Periode</label>
									<div class="col-md-6">
									<input type="text" name="periode" readonly class="form-control" value="<?=$mail['periode_name'];?>">
									</div>
						</div>
						<div class="form-group">
						...
						<div class="form-actions right">
								<button id="input-form-send-register"  name="send_apex" class="btn green ladda-button" data-style="expand-right">Save & Send Mail</button>
								<button id="input-form-save-register"  name="save_apex" class="btn blue ladda-button" data-style="expand-right">Save</button>
