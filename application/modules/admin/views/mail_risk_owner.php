...
<div class="page-content-wrapper">
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		Mail Risk Owner to confirm the Risks that assigned to your division
		</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="javascript:;">Reminder for risk owner to confirm the risks that assigned to your division</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
				...
				<form  action="<?=$site_url?>/admin/reminder/send_mail_risk" method="post" id="input-form" role="form" class="form-horizontal">
					<div class="form-body">
						...
						<div class="form-actions right">
								<button id="input-form-send-register"  name="send_owner_risk" class="btn green ladda-button" data-style="expand-right">Save & Send Mail</button>
								<button id="input-form-save-register"  name="save_owner_risk" class="btn blue ladda-button" data-style="expand-right">Save</button>
