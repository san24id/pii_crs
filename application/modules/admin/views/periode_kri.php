		...
		<div id="form-data" class="modal fade" tabindex="-1" data-width="760" data-keyboard="false">
			...
			<div class="modal-body">
				<div class="row">
					...
					<br /><br />
			 		<span style="color:#035CFF;"><p align="left" style="padding-left: 20px;"><i>Note : <br/>This period only affect to open the process of regular key risk indikator which can be opened from menu.
