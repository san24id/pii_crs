		...
		<div id="form-data" class="modal fade" tabindex="-1" data-width="760" data-keyboard="false">
			...
			<div class="modal-body">
				<div class="row">
					...
					<br /><br />
			 		<span style="color:#035CFF;"><p align="left" style="padding-left: 20px;"><i>Note : <br/>This period only affect to open the process of regular action plan execution which can be opened from menu.
Please go to the other setting period if you wanna open the other process
</i></p></span>
				</div>
			</div>
