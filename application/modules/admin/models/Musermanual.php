...
class Musermanual extends APP_Model {
	...
	public function getAllPublished()
	{
		...
		$sql = "select 
				...
				from t_user_manual a left join
				m_user b on a.created_by = b.username
				where a.status = 1 and a.id_user = 6";
		}else if($role == 7){
		$sql = "select 
				a.*, b.display_name as created_by_v,
				date_format(a.created_date, '%d-%m-%Y') as created_date_v,
				...
				from t_user_manual a left join
				m_user b on a.created_by = b.username
				where a.status = 1 and a.id_user = 7";
		}else if($role == 8){
		$sql = "select 
				a.*, b.display_name as created_by_v,
				date_format(a.created_date, '%d-%m-%Y') as created_date_v,
				...
				from t_user_manual a left join
				m_user b on a.created_by = b.username
				where a.status = 1 and a.id_user = 8";
		}else if($role == 9){
		$sql = "select 
				a.*, b.display_name as created_by_v,
				date_format(a.created_date, '%d-%m-%Y') as created_date_v,
				...
				from t_user_manual a left join
				m_user b on a.created_by = b.username
				where a.status = 1 and a.id_user = 9";
		}else if($role == 2){
		$sql = "select 
				a.*, b.display_name as created_by_v,
				date_format(a.created_date, '%d-%m-%Y') as created_date_v,
		...
		public function getAllStepNewPeriod()
	{
		$role = $this->session->credential['role_id'];
		...
		$sql = "select 
				...
				from t_user_newperiod a left join
				m_user b on a.created_by = b.username
				where a.status = 1 and a.id_user = 2";
	...
	public function stepNewPeriodById($id)
	{
		$sql = "select 
				a.*, b.display_name as created_by_v,
				date_format(a.created_date, '%d-%m-%Y') as created_date_v,
