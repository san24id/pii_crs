...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		Action Plan Execution Periode : <?php 
			$this->load->database();
			$sql = "SELECT * FROM  m_periode a LEFT JOIN (select * from mail_ap_execution b where b.periode_id =(SELECT MAX(periode_id) FROM m_periode) ORDER by b.id DESC ) c ON a.periode_id = c.periode_id WHERE a.periode_id IN (SELECT MAX(periode_id) FROM m_periode)";
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a target="_self" href="javascript:;">Regular Action Plan Execution</a>
				</li>
			</ul>
			<div class="page-toolbar">
				...
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu pull-right" role="menu">
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/main/getExecutionRegularUser_pdf?role=$role&divisi=$divisi&user=$user");?>">PDF</a>
						</li>
						<li>
							<a  target="_blank" href="<?php echo base_url("index.php/main/getExecutionRegularUser_excel?role=$role&divisi=$divisi&user=$user");?>">Excel</a>
						</li>
